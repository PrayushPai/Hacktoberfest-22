...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	0a250513          	addi	a0,a0,162 # 60e0 <malloc+0xe6>
      46:	00006097          	auipc	ra,0x6
      4a:	efc080e7          	jalr	-260(ra) # 5f42 <printf>
      exit(1);
      4e:	4505                	li	a0,1
      ...
      74:	8082                	ret
{
      ...
      84:	08050513          	addi	a0,a0,128 # 6100 <malloc+0x106>
      88:	00006097          	auipc	ra,0x6
      8c:	eba080e7          	jalr	-326(ra) # 5f42 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	07050513          	addi	a0,a0,112 # 6118 <malloc+0x11e>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	07250513          	addi	a0,a0,114 # 6138 <malloc+0x13e>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	03a50513          	addi	a0,a0,58 # 6120 <malloc+0x126>
      ee:	00006097          	auipc	ra,0x6
      f2:	e54080e7          	jalr	-428(ra) # 5f42 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	04650513          	addi	a0,a0,70 # 6148 <malloc+0x14e>
     10a:	00006097          	auipc	ra,0x6
     10e:	e38080e7          	jalr	-456(ra) # 5f42 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	04450513          	addi	a0,a0,68 # 6170 <malloc+0x176>
     134:	00006097          	auipc	ra,0x6
     138:	adc080e7          	jalr	-1316(ra) # 5c10 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	03050513          	addi	a0,a0,48 # 6170 <malloc+0x176>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	02c58593          	addi	a1,a1,44 # 6180 <malloc+0x186>
     15c:	00006097          	auipc	ra,0x6
     160:	a84080e7          	jalr	-1404(ra) # 5be0 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	00850513          	addi	a0,a0,8 # 6170 <malloc+0x176>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	00c58593          	addi	a1,a1,12 # 6188 <malloc+0x18e>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	fdc50513          	addi	a0,a0,-36 # 6170 <malloc+0x176>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	fc650513          	addi	a0,a0,-58 # 6190 <malloc+0x196>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	d70080e7          	jalr	-656(ra) # 5f42 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	f3c50513          	addi	a0,a0,-196 # 61b8 <malloc+0x1be>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	f28a8a93          	addi	s5,s5,-216 # 61b8 <malloc+0x1be>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	eb650513          	addi	a0,a0,-330 # 61c8 <malloc+0x1ce>
     31a:	00006097          	auipc	ra,0x6
     31e:	c28080e7          	jalr	-984(ra) # 5f42 <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     338:	eb450513          	addi	a0,a0,-332 # 61e8 <malloc+0x1ee>
     33c:	00006097          	auipc	ra,0x6
     340:	c06080e7          	jalr	-1018(ra) # 5f42 <printf>
        exit(1);
     344:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     362:	ea250513          	addi	a0,a0,-350 # 6200 <malloc+0x206>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     376:	e8e98993          	addi	s3,s3,-370 # 6200 <malloc+0x206>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c2:	e4250513          	addi	a0,a0,-446 # 6200 <malloc+0x206>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3da:	db258593          	addi	a1,a1,-590 # 6188 <malloc+0x18e>
    ...
    printf("write failed\n");
     ...
     3f0:	e3450513          	addi	a0,a0,-460 # 6220 <malloc+0x226>
     3f4:	00006097          	auipc	ra,0x6
     3f8:	b4e080e7          	jalr	-1202(ra) # 5f42 <printf>
    exit(1);
     3fc:	4505                	li	a0,1
     ...
     40a:	e0250513          	addi	a0,a0,-510 # 6208 <malloc+0x20e>
     40e:	00006097          	auipc	ra,0x6
     412:	b34080e7          	jalr	-1228(ra) # 5f42 <printf>
      exit(1);
     416:	4505                	li	a0,1
    ...
    printf("open junk failed\n");
     ...
     424:	de850513          	addi	a0,a0,-536 # 6208 <malloc+0x20e>
     428:	00006097          	auipc	ra,0x6
     42c:	b1a080e7          	jalr	-1254(ra) # 5f42 <printf>
    exit(1);
     430:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     448:	dbc50513          	addi	a0,a0,-580 # 6200 <malloc+0x206>
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	ce0a0a13          	addi	s4,s4,-800 # 6230 <malloc+0x236>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	c3c50513          	addi	a0,a0,-964 # 6238 <malloc+0x23e>
     604:	00006097          	auipc	ra,0x6
     608:	93e080e7          	jalr	-1730(ra) # 5f42 <printf>
      exit(1);
     60c:	4505                	li	a0,1
     ...
     61e:	c3650513          	addi	a0,a0,-970 # 6250 <malloc+0x256>
     622:	00006097          	auipc	ra,0x6
     626:	920080e7          	jalr	-1760(ra) # 5f42 <printf>
      exit(1);
     62a:	4505                	li	a0,1
     ...
     63c:	c4850513          	addi	a0,a0,-952 # 6280 <malloc+0x286>
     640:	00006097          	auipc	ra,0x6
     644:	902080e7          	jalr	-1790(ra) # 5f42 <printf>
      exit(1);
     648:	4505                	li	a0,1
     ...
     656:	c5e50513          	addi	a0,a0,-930 # 62b0 <malloc+0x2b6>
     65a:	00006097          	auipc	ra,0x6
     65e:	8e8080e7          	jalr	-1816(ra) # 5f42 <printf>
      exit(1);
     662:	4505                	li	a0,1
     ...
     674:	c5050513          	addi	a0,a0,-944 # 62c0 <malloc+0x2c6>
     678:	00006097          	auipc	ra,0x6
     67c:	8ca080e7          	jalr	-1846(ra) # 5f42 <printf>
      exit(1);
     680:	4505                	li	a0,1
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b2:	c42a0a13          	addi	s4,s4,-958 # 62f0 <malloc+0x2f6>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	ad2a8a93          	addi	s5,s5,-1326 # 6188 <malloc+0x18e>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     760:	b9c50513          	addi	a0,a0,-1124 # 62f8 <malloc+0x2fe>
     764:	00005097          	auipc	ra,0x5
     768:	7de080e7          	jalr	2014(ra) # 5f42 <printf>
      exit(1);
     76c:	4505                	li	a0,1
     ...
     77e:	b9650513          	addi	a0,a0,-1130 # 6310 <malloc+0x316>
     782:	00005097          	auipc	ra,0x5
     786:	7c0080e7          	jalr	1984(ra) # 5f42 <printf>
      exit(1);
     78a:	4505                	li	a0,1
     ...
     798:	b1c50513          	addi	a0,a0,-1252 # 62b0 <malloc+0x2b6>
     79c:	00005097          	auipc	ra,0x5
     7a0:	7a6080e7          	jalr	1958(ra) # 5f42 <printf>
      exit(1);
     7a4:	4505                	li	a0,1
     ...
     7b2:	b9250513          	addi	a0,a0,-1134 # 6340 <malloc+0x346>
     7b6:	00005097          	auipc	ra,0x5
     7ba:	78c080e7          	jalr	1932(ra) # 5f42 <printf>
      exit(1);
     7be:	4505                	li	a0,1
     ...
     7d0:	b8c50513          	addi	a0,a0,-1140 # 6358 <malloc+0x35e>
     7d4:	00005097          	auipc	ra,0x5
     7d8:	76e080e7          	jalr	1902(ra) # 5f42 <printf>
      exit(1);
     7dc:	4505                	li	a0,1
...
00000000000007e6 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     826:	95e58593          	addi	a1,a1,-1698 # 6180 <malloc+0x186>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	93250513          	addi	a0,a0,-1742 # 6170 <malloc+0x176>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     86e:	90650513          	addi	a0,a0,-1786 # 6170 <malloc+0x176>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	8f250513          	addi	a0,a0,-1806 # 6170 <malloc+0x176>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	b2c58593          	addi	a1,a1,-1236 # 63e8 <malloc+0x3ee>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	87250513          	addi	a0,a0,-1934 # 6170 <malloc+0x176>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	a4650513          	addi	a0,a0,-1466 # 6388 <malloc+0x38e>
     94a:	00005097          	auipc	ra,0x5
     94e:	5f8080e7          	jalr	1528(ra) # 5f42 <printf>
    exit(1);
     952:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	a4a50513          	addi	a0,a0,-1462 # 63a8 <malloc+0x3ae>
     966:	00005097          	auipc	ra,0x5
     96a:	5dc080e7          	jalr	1500(ra) # 5f42 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     96e:	8652                	mv	a2,s4
     970:	85d6                	mv	a1,s5
     972:	00006517          	auipc	a0,0x6
     976:	a4650513          	addi	a0,a0,-1466 # 63b8 <malloc+0x3be>
     97a:	00005097          	auipc	ra,0x5
     97e:	5c8080e7          	jalr	1480(ra) # 5f42 <printf>
    exit(1);
     982:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	a4a50513          	addi	a0,a0,-1462 # 63d8 <malloc+0x3de>
     996:	00005097          	auipc	ra,0x5
     99a:	5ac080e7          	jalr	1452(ra) # 5f42 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     99e:	8652                	mv	a2,s4
     9a0:	85d6                	mv	a1,s5
     9a2:	00006517          	auipc	a0,0x6
     9a6:	a1650513          	addi	a0,a0,-1514 # 63b8 <malloc+0x3be>
     9aa:	00005097          	auipc	ra,0x5
     9ae:	598080e7          	jalr	1432(ra) # 5f42 <printf>
    exit(1);
     9b2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	a3050513          	addi	a0,a0,-1488 # 63f0 <malloc+0x3f6>
     9c8:	00005097          	auipc	ra,0x5
     9cc:	57a080e7          	jalr	1402(ra) # 5f42 <printf>
    exit(1);
     9d0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	a3250513          	addi	a0,a0,-1486 # 6410 <malloc+0x416>
     9e6:	00005097          	auipc	ra,0x5
     9ea:	55c080e7          	jalr	1372(ra) # 5f42 <printf>
    exit(1);
     9ee:	4505                	li	a0,1
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a16:	a1e50513          	addi	a0,a0,-1506 # 6430 <malloc+0x436>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a2e:	a2e98993          	addi	s3,s3,-1490 # 6458 <malloc+0x45e>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a32:	00006a97          	auipc	s5,0x6
     a36:	a5ea8a93          	addi	s5,s5,-1442 # 6490 <malloc+0x496>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	9b850513          	addi	a0,a0,-1608 # 6430 <malloc+0x436>
  ...
  if(unlink("small") < 0){
     ...
     ab8:	97c50513          	addi	a0,a0,-1668 # 6430 <malloc+0x436>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	95a50513          	addi	a0,a0,-1702 # 6438 <malloc+0x43e>
     ae6:	00005097          	auipc	ra,0x5
     aea:	45c080e7          	jalr	1116(ra) # 5f42 <printf>
    exit(1);
     aee:	4505                	li	a0,1
     ...
     b00:	96c50513          	addi	a0,a0,-1684 # 6468 <malloc+0x46e>
     b04:	00005097          	auipc	ra,0x5
     b08:	43e080e7          	jalr	1086(ra) # 5f42 <printf>
      exit(1);
     b0c:	4505                	li	a0,1
     ...
     b1e:	98650513          	addi	a0,a0,-1658 # 64a0 <malloc+0x4a6>
     b22:	00005097          	auipc	ra,0x5
     b26:	420080e7          	jalr	1056(ra) # 5f42 <printf>
      exit(1);
     b2a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	99250513          	addi	a0,a0,-1646 # 64c8 <malloc+0x4ce>
     b3e:	00005097          	auipc	ra,0x5
     b42:	404080e7          	jalr	1028(ra) # 5f42 <printf>
    exit(1);
     b46:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	99650513          	addi	a0,a0,-1642 # 64e8 <malloc+0x4ee>
     b5a:	00005097          	auipc	ra,0x5
     b5e:	3e8080e7          	jalr	1000(ra) # 5f42 <printf>
    exit(1);
     b62:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	99250513          	addi	a0,a0,-1646 # 6500 <malloc+0x506>
     b76:	00005097          	auipc	ra,0x5
     b7a:	3cc080e7          	jalr	972(ra) # 5f42 <printf>
    exit(1);
     b7e:	4505                	li	a0,1
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba4:	98050513          	addi	a0,a0,-1664 # 6520 <malloc+0x526>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	92e50513          	addi	a0,a0,-1746 # 6520 <malloc+0x526>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	8ee50513          	addi	a0,a0,-1810 # 6528 <malloc+0x52e>
     c42:	00005097          	auipc	ra,0x5
     c46:	300080e7          	jalr	768(ra) # 5f42 <printf>
    exit(1);
     c4a:	4505                	li	a0,1
     ...
     c5c:	8f050513          	addi	a0,a0,-1808 # 6548 <malloc+0x54e>
     c60:	00005097          	auipc	ra,0x5
     c64:	2e2080e7          	jalr	738(ra) # 5f42 <printf>
      exit(1);
     c68:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	8fc50513          	addi	a0,a0,-1796 # 6570 <malloc+0x576>
     c7c:	00005097          	auipc	ra,0x5
     c80:	2c6080e7          	jalr	710(ra) # 5f42 <printf>
    exit(1);
     c84:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ca4:	88050513          	addi	a0,a0,-1920 # 6520 <malloc+0x526>
     ...
     cd0:	8c450513          	addi	a0,a0,-1852 # 6590 <malloc+0x596>
     cd4:	00005097          	auipc	ra,0x5
     cd8:	26e080e7          	jalr	622(ra) # 5f42 <printf>
        exit(1);
     cdc:	4505                	li	a0,1
     ...
     cee:	8ce50513          	addi	a0,a0,-1842 # 65b8 <malloc+0x5be>
     cf2:	00005097          	auipc	ra,0x5
     cf6:	250080e7          	jalr	592(ra) # 5f42 <printf>
      exit(1);
     cfa:	4505                	li	a0,1
     ...
     d0c:	8c850513          	addi	a0,a0,-1848 # 65d0 <malloc+0x5d6>
     d10:	00005097          	auipc	ra,0x5
     d14:	232080e7          	jalr	562(ra) # 5f42 <printf>
      exit(1);
     d18:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	8d450513          	addi	a0,a0,-1836 # 65f8 <malloc+0x5fe>
     d2c:	00005097          	auipc	ra,0x5
     d30:	216080e7          	jalr	534(ra) # 5f42 <printf>
    exit(1);
     d34:	4505                	li	a0,1
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	8be50513          	addi	a0,a0,-1858 # 6610 <malloc+0x616>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	8d658593          	addi	a1,a1,-1834 # 6640 <malloc+0x646>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	88a50513          	addi	a0,a0,-1910 # 6610 <malloc+0x616>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da0:	87450513          	addi	a0,a0,-1932 # 6610 <malloc+0x616>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	85e50513          	addi	a0,a0,-1954 # 6610 <malloc+0x616>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	8c258593          	addi	a1,a1,-1854 # 6688 <malloc+0x68e>
  ...
  unlink("unlinkread");
     ...
     e32:	7e250513          	addi	a0,a0,2018 # 6610 <malloc+0x616>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	7d250513          	addi	a0,a0,2002 # 6620 <malloc+0x626>
     e56:	00005097          	auipc	ra,0x5
     e5a:	0ec080e7          	jalr	236(ra) # 5f42 <printf>
    exit(1);
     e5e:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	7de50513          	addi	a0,a0,2014 # 6648 <malloc+0x64e>
     e72:	00005097          	auipc	ra,0x5
     e76:	0d0080e7          	jalr	208(ra) # 5f42 <printf>
    exit(1);
     e7a:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	7e250513          	addi	a0,a0,2018 # 6668 <malloc+0x66e>
     e8e:	00005097          	auipc	ra,0x5
     e92:	0b4080e7          	jalr	180(ra) # 5f42 <printf>
    exit(1);
     e96:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	7ee50513          	addi	a0,a0,2030 # 6690 <malloc+0x696>
     eaa:	00005097          	auipc	ra,0x5
     eae:	098080e7          	jalr	152(ra) # 5f42 <printf>
    exit(1);
     eb2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	7f250513          	addi	a0,a0,2034 # 66b0 <malloc+0x6b6>
     ec6:	00005097          	auipc	ra,0x5
     eca:	07c080e7          	jalr	124(ra) # 5f42 <printf>
    exit(1);
     ece:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	7f650513          	addi	a0,a0,2038 # 66d0 <malloc+0x6d6>
     ee2:	00005097          	auipc	ra,0x5
     ee6:	060080e7          	jalr	96(ra) # 5f42 <printf>
    exit(1);
     eea:	4505                	li	a0,1
...
0000000000000ef4 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f42:	70258593          	addi	a1,a1,1794 # 6640 <malloc+0x646>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f62:	79a58593          	addi	a1,a1,1946 # 66f8 <malloc+0x6fe>
     f66:	00005517          	auipc	a0,0x5
     f6a:	78a50513          	addi	a0,a0,1930 # 66f0 <malloc+0x6f6>
  ...
  unlink("lf1");
     ...
     f7e:	77650513          	addi	a0,a0,1910 # 66f0 <malloc+0x6f6>
     f82:	00005097          	auipc	ra,0x5
     f86:	c8e080e7          	jalr	-882(ra) # 5c10 <unlink>
  if(open("lf1", 0) >= 0){
     f8a:	4581                	li	a1,0
     f8c:	00005517          	auipc	a0,0x5
     f90:	76450513          	addi	a0,a0,1892 # 66f0 <malloc+0x6f6>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	75650513          	addi	a0,a0,1878 # 66f8 <malloc+0x6fe>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fde:	71e58593          	addi	a1,a1,1822 # 66f8 <malloc+0x6fe>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	70850513          	addi	a0,a0,1800 # 66f8 <malloc+0x6fe>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	c18080e7          	jalr	-1000(ra) # 5c10 <unlink>
  if(link("lf2", "lf1") >= 0){
    1000:	00005597          	auipc	a1,0x5
    1004:	6f058593          	addi	a1,a1,1776 # 66f0 <malloc+0x6f6>
    1008:	00005517          	auipc	a0,0x5
    100c:	6f050513          	addi	a0,a0,1776 # 66f8 <malloc+0x6fe>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1020:	6d458593          	addi	a1,a1,1748 # 66f0 <malloc+0x6f6>
    1024:	00005517          	auipc	a0,0x5
    1028:	7dc50513          	addi	a0,a0,2012 # 6800 <malloc+0x806>
    ...
    104a:	6ba50513          	addi	a0,a0,1722 # 6700 <malloc+0x706>
    104e:	00005097          	auipc	ra,0x5
    1052:	ef4080e7          	jalr	-268(ra) # 5f42 <printf>
    exit(1);
    1056:	4505                	li	a0,1
    ...
    1066:	6b650513          	addi	a0,a0,1718 # 6718 <malloc+0x71e>
    106a:	00005097          	auipc	ra,0x5
    106e:	ed8080e7          	jalr	-296(ra) # 5f42 <printf>
    exit(1);
    1072:	4505                	li	a0,1
    ...
    1082:	6b250513          	addi	a0,a0,1714 # 6730 <malloc+0x736>
    1086:	00005097          	auipc	ra,0x5
    108a:	ebc080e7          	jalr	-324(ra) # 5f42 <printf>
    exit(1);
    108e:	4505                	li	a0,1
    ...
    109e:	6b650513          	addi	a0,a0,1718 # 6750 <malloc+0x756>
    10a2:	00005097          	auipc	ra,0x5
    10a6:	ea0080e7          	jalr	-352(ra) # 5f42 <printf>
    exit(1);
    10aa:	4505                	li	a0,1
    ...
    10ba:	6ca50513          	addi	a0,a0,1738 # 6780 <malloc+0x786>
    10be:	00005097          	auipc	ra,0x5
    10c2:	e84080e7          	jalr	-380(ra) # 5f42 <printf>
    exit(1);
    10c6:	4505                	li	a0,1
    ...
    10d6:	6c650513          	addi	a0,a0,1734 # 6798 <malloc+0x79e>
    10da:	00005097          	auipc	ra,0x5
    10de:	e68080e7          	jalr	-408(ra) # 5f42 <printf>
    exit(1);
    10e2:	4505                	li	a0,1
    ...
    10f2:	6c250513          	addi	a0,a0,1730 # 67b0 <malloc+0x7b6>
    10f6:	00005097          	auipc	ra,0x5
    10fa:	e4c080e7          	jalr	-436(ra) # 5f42 <printf>
    exit(1);
    10fe:	4505                	li	a0,1
    ...
    110e:	6ce50513          	addi	a0,a0,1742 # 67d8 <malloc+0x7de>
    1112:	00005097          	auipc	ra,0x5
    1116:	e30080e7          	jalr	-464(ra) # 5f42 <printf>
    exit(1);
    111a:	4505                	li	a0,1
    ...
    112a:	6e250513          	addi	a0,a0,1762 # 6808 <malloc+0x80e>
    112e:	00005097          	auipc	ra,0x5
    1132:	e14080e7          	jalr	-492(ra) # 5f42 <printf>
    exit(1);
    1136:	4505                	li	a0,1
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115c:	6d098993          	addi	s3,s3,1744 # 6828 <malloc+0x82e>
    1160:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1198:	6a450513          	addi	a0,a0,1700 # 6838 <malloc+0x83e>
    119c:	00005097          	auipc	ra,0x5
    11a0:	da6080e7          	jalr	-602(ra) # 5f42 <printf>
      exit(1);
    11a4:	4505                	li	a0,1
...
00000000000011ae <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    11fe:	65ea0a13          	addi	s4,s4,1630 # 6858 <malloc+0x85e>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1250:	60c50513          	addi	a0,a0,1548 # 6858 <malloc+0x85e>
  ...
  for(i = 0; i < N; i++){
    ...
    12c0:	5a450513          	addi	a0,a0,1444 # 6860 <malloc+0x866>
    12c4:	00005097          	auipc	ra,0x5
    12c8:	c7e080e7          	jalr	-898(ra) # 5f42 <printf>
    exit(1);
    12cc:	4505                	li	a0,1
    ...
    12e0:	5a450513          	addi	a0,a0,1444 # 6880 <malloc+0x886>
    12e4:	00005097          	auipc	ra,0x5
    12e8:	c5e080e7          	jalr	-930(ra) # 5f42 <printf>
      exit(1);
    12ec:	4505                	li	a0,1
    ...
    12fc:	5a850513          	addi	a0,a0,1448 # 68a0 <malloc+0x8a6>
    1300:	00005097          	auipc	ra,0x5
    1304:	c42080e7          	jalr	-958(ra) # 5f42 <printf>
      exit(1);
    1308:	4505                	li	a0,1
...
000000000000134a <badarg>:
{
    ...
    1368:	db498993          	addi	s3,s3,-588 # 6118 <malloc+0x11e>
    argv[0] = (char*)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f2:	70a78793          	addi	a5,a5,1802 # 7af8 <malloc+0x1afe>
  ...
  if(pid == 0){
    ...
    144e:	0e678793          	addi	a5,a5,230 # 8530 <malloc+0x2536>
    ...
    1472:	caa50513          	addi	a0,a0,-854 # 6118 <malloc+0x11e>
    ...
    148a:	4c250513          	addi	a0,a0,1218 # 6948 <malloc+0x94e>
    148e:	00005097          	auipc	ra,0x5
    1492:	ab4080e7          	jalr	-1356(ra) # 5f42 <printf>
      exit(1);
    1496:	4505                	li	a0,1
    ...
    14aa:	41a50513          	addi	a0,a0,1050 # 68c0 <malloc+0x8c6>
    14ae:	00005097          	auipc	ra,0x5
    14b2:	a94080e7          	jalr	-1388(ra) # 5f42 <printf>
    exit(1);
    14b6:	4505                	li	a0,1
    ...
    14ca:	41a50513          	addi	a0,a0,1050 # 68e0 <malloc+0x8e6>
    14ce:	00005097          	auipc	ra,0x5
    14d2:	a74080e7          	jalr	-1420(ra) # 5f42 <printf>
    exit(1);
    14d6:	4505                	li	a0,1
    ...
    14ec:	41850513          	addi	a0,a0,1048 # 6900 <malloc+0x906>
    14f0:	00005097          	auipc	ra,0x5
    14f4:	a52080e7          	jalr	-1454(ra) # 5f42 <printf>
    exit(1);
    14f8:	4505                	li	a0,1
    ...
    150c:	42050513          	addi	a0,a0,1056 # 6928 <malloc+0x92e>
    1510:	00005097          	auipc	ra,0x5
    1514:	a32080e7          	jalr	-1486(ra) # 5f42 <printf>
    exit(1);
    1518:	4505                	li	a0,1
    ...
    1526:	88650513          	addi	a0,a0,-1914 # 6da8 <malloc+0xdae>
    152a:	00005097          	auipc	ra,0x5
    152e:	a18080e7          	jalr	-1512(ra) # 5f42 <printf>
    exit(1);
    1532:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1570:	40450513          	addi	a0,a0,1028 # 6970 <malloc+0x976>
    1574:	00005097          	auipc	ra,0x5
    1578:	9ce080e7          	jalr	-1586(ra) # 5f42 <printf>
    exit(1);
    157c:	4505                	li	a0,1
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a2:	bd250513          	addi	a0,a0,-1070 # 6170 <malloc+0x176>
  ...
  if(pid == 0){
    ...
    15cc:	ba8a0a13          	addi	s4,s4,-1112 # 6170 <malloc+0x176>
      int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	400a8a93          	addi	s5,s5,1024 # 69d0 <malloc+0x9d6>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    1644:	36050513          	addi	a0,a0,864 # 69a0 <malloc+0x9a6>
    1648:	00005097          	auipc	ra,0x5
    164c:	8fa080e7          	jalr	-1798(ra) # 5f42 <printf>
    exit(1);
    1650:	4505                	li	a0,1
    ...
    1660:	35c50513          	addi	a0,a0,860 # 69b8 <malloc+0x9be>
    1664:	00005097          	auipc	ra,0x5
    1668:	8de080e7          	jalr	-1826(ra) # 5f42 <printf>
        exit(1);
    166c:	4505                	li	a0,1
    ...
    167e:	36650513          	addi	a0,a0,870 # 69e0 <malloc+0x9e6>
    1682:	00005097          	auipc	ra,0x5
    1686:	8c0080e7          	jalr	-1856(ra) # 5f42 <printf>
        exit(1);
    168a:	4505                	li	a0,1
    ...
    169c:	ad8a0a13          	addi	s4,s4,-1320 # 6170 <malloc+0x176>
    int n = write(fd, "xxx", 3);
    16a0:	00005a97          	auipc	s5,0x5
    16a4:	360a8a93          	addi	s5,s5,864 # 6a00 <malloc+0xa06>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16ee:	a8650513          	addi	a0,a0,-1402 # 6170 <malloc+0x176>
  ...
  exit(xstatus);
    ...
    170c:	2b050513          	addi	a0,a0,688 # 69b8 <malloc+0x9be>
    1710:	00005097          	auipc	ra,0x5
    1714:	832080e7          	jalr	-1998(ra) # 5f42 <printf>
      exit(1);
    1718:	4505                	li	a0,1
    ...
    172a:	2e250513          	addi	a0,a0,738 # 6a08 <malloc+0xa0e>
    172e:	00005097          	auipc	ra,0x5
    1732:	814080e7          	jalr	-2028(ra) # 5f42 <printf>
      exit(1);
    1736:	4505                	li	a0,1
...
0000000000001740 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1752:	9ca78793          	addi	a5,a5,-1590 # 6118 <malloc+0x11e>
    1756:	fcf43023          	sd	a5,-64(s0)
    175a:	00005797          	auipc	a5,0x5
    175e:	2ce78793          	addi	a5,a5,718 # 6a28 <malloc+0xa2e>
    1762:	fcf43423          	sd	a5,-56(s0)
    1766:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176a:	00005517          	auipc	a0,0x5
    176e:	2c650513          	addi	a0,a0,710 # 6a30 <malloc+0xa36>
  ...
  if(pid == 0) {
    ...
    179c:	29850513          	addi	a0,a0,664 # 6a30 <malloc+0xa36>
    ...
    17b8:	29c50513          	addi	a0,a0,668 # 6a50 <malloc+0xa56>
    17bc:	00004097          	auipc	ra,0x4
    17c0:	786080e7          	jalr	1926(ra) # 5f42 <printf>
      exit(1);
    17c4:	4505                	li	a0,1
    ...
    17d4:	1d050513          	addi	a0,a0,464 # 69a0 <malloc+0x9a6>
    17d8:	00004097          	auipc	ra,0x4
    17dc:	76a080e7          	jalr	1898(ra) # 5f42 <printf>
     exit(1);
    17e0:	4505                	li	a0,1
    ...
    17f0:	24c50513          	addi	a0,a0,588 # 6a38 <malloc+0xa3e>
    17f4:	00004097          	auipc	ra,0x4
    17f8:	74e080e7          	jalr	1870(ra) # 5f42 <printf>
      exit(1);
    17fc:	4505                	li	a0,1
    ...
    180e:	90e50513          	addi	a0,a0,-1778 # 6118 <malloc+0x11e>
  ...
  if(xstatus != 0)
    ...
    1842:	22250513          	addi	a0,a0,546 # 6a60 <malloc+0xa66>
    1846:	00004097          	auipc	ra,0x4
    184a:	6fc080e7          	jalr	1788(ra) # 5f42 <printf>
      exit(1);
    184e:	4505                	li	a0,1
    ...
    185e:	21e50513          	addi	a0,a0,542 # 6a78 <malloc+0xa7e>
    1862:	00004097          	auipc	ra,0x4
    1866:	6e0080e7          	jalr	1760(ra) # 5f42 <printf>
    186a:	b7d1                	j	182e <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    186c:	4581                	li	a1,0
    186e:	00005517          	auipc	a0,0x5
    1872:	1c250513          	addi	a0,a0,450 # 6a30 <malloc+0xa36>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189c:	c5050513          	addi	a0,a0,-944 # 64e8 <malloc+0x4ee>
    18a0:	00004097          	auipc	ra,0x4
    18a4:	6a2080e7          	jalr	1698(ra) # 5f42 <printf>
    exit(1);
    18a8:	4505                	li	a0,1
    ...
    18b8:	10450513          	addi	a0,a0,260 # 69b8 <malloc+0x9be>
    18bc:	00004097          	auipc	ra,0x4
    18c0:	686080e7          	jalr	1670(ra) # 5f42 <printf>
    exit(1);
    18c4:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    18d2:	16250513          	addi	a0,a0,354 # 6a30 <malloc+0xa36>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fc:	19850513          	addi	a0,a0,408 # 6a90 <malloc+0xa96>
    1900:	00004097          	auipc	ra,0x4
    1904:	642080e7          	jalr	1602(ra) # 5f42 <printf>
    exit(1);
    1908:	4505                	li	a0,1
...
000000000000191c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19bc:	0f050513          	addi	a0,a0,240 # 6aa8 <malloc+0xaae>
    19c0:	00004097          	auipc	ra,0x4
    19c4:	582080e7          	jalr	1410(ra) # 5f42 <printf>
    exit(1);
    19c8:	4505                	li	a0,1
    ...
    19f6:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a42:	08250513          	addi	a0,a0,130 # 6ac0 <malloc+0xac6>
    1a46:	00004097          	auipc	ra,0x4
    1a4a:	4fc080e7          	jalr	1276(ra) # 5f42 <printf>
        exit(1);
    1a4e:	4505                	li	a0,1
    ...
    1a5e:	07e50513          	addi	a0,a0,126 # 6ad8 <malloc+0xade>
    1a62:	00004097          	auipc	ra,0x4
    1a66:	4e0080e7          	jalr	1248(ra) # 5f42 <printf>
}
    ...
    1a90:	06450513          	addi	a0,a0,100 # 6af0 <malloc+0xaf6>
    1a94:	00004097          	auipc	ra,0x4
    1a98:	4ae080e7          	jalr	1198(ra) # 5f42 <printf>
      exit(1);
    1a9c:	4505                	li	a0,1
    ...
    1ad0:	04450513          	addi	a0,a0,68 # 6b10 <malloc+0xb16>
    1ad4:	00004097          	auipc	ra,0x4
    1ad8:	46e080e7          	jalr	1134(ra) # 5f42 <printf>
    exit(1);
    1adc:	4505                	li	a0,1
...
0000000000001ae6 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b42:	e6250513          	addi	a0,a0,-414 # 69a0 <malloc+0x9a6>
    1b46:	00004097          	auipc	ra,0x4
    1b4a:	3fc080e7          	jalr	1020(ra) # 5f42 <printf>
      exit(1);
    1b4e:	4505                	li	a0,1
    ...
    1b5e:	fce50513          	addi	a0,a0,-50 # 6b28 <malloc+0xb2e>
    1b62:	00004097          	auipc	ra,0x4
    1b66:	3e0080e7          	jalr	992(ra) # 5f42 <printf>
        exit(1);
    1b6a:	4505                	li	a0,1
    ...
    1b7a:	fca50513          	addi	a0,a0,-54 # 6b40 <malloc+0xb46>
    1b7e:	00004097          	auipc	ra,0x4
    1b82:	3c4080e7          	jalr	964(ra) # 5f42 <printf>
        exit(1);
    1b86:	4505                	li	a0,1
...
0000000000001b9a <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf2:	db250513          	addi	a0,a0,-590 # 69a0 <malloc+0x9a6>
    1bf6:	00004097          	auipc	ra,0x4
    1bfa:	34c080e7          	jalr	844(ra) # 5f42 <printf>
      exit(1);
    1bfe:	4505                	li	a0,1
    ...
    1c16:	d8e50513          	addi	a0,a0,-626 # 69a0 <malloc+0x9a6>
    1c1a:	00004097          	auipc	ra,0x4
    1c1e:	328080e7          	jalr	808(ra) # 5f42 <printf>
        exit(1);
    1c22:	4505                	li	a0,1
...
0000000000001c34 <forkfork>:
{
    ...
    1c90:	ed450513          	addi	a0,a0,-300 # 6b60 <malloc+0xb66>
    1c94:	00004097          	auipc	ra,0x4
    1c98:	2ae080e7          	jalr	686(ra) # 5f42 <printf>
      exit(1);
    1c9c:	4505                	li	a0,1
    ...
    1ca2:	f22080e7          	jalr	-222(ra) # 5bc0 <exit>
{
    ...
    1ce8:	e8c50513          	addi	a0,a0,-372 # 6b70 <malloc+0xb76>
    1cec:	00004097          	auipc	ra,0x4
    1cf0:	256080e7          	jalr	598(ra) # 5f42 <printf>
      exit(1);
    1cf4:	4505                	li	a0,1
...
0000000000001cfe <reparent2>:
{
  ...
  exit(0);
    ...
    1d36:	07650513          	addi	a0,a0,118 # 6da8 <malloc+0xdae>
    1d3a:	00004097          	auipc	ra,0x4
    1d3e:	208080e7          	jalr	520(ra) # 5f42 <printf>
      exit(1);
    1d42:	4505                	li	a0,1
...
0000000000001d66 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd4:	fd850513          	addi	a0,a0,-40 # 6da8 <malloc+0xdae>
    1dd8:	00004097          	auipc	ra,0x4
    1ddc:	16a080e7          	jalr	362(ra) # 5f42 <printf>
      exit(1);
    1de0:	4505                	li	a0,1
    ...
    1e00:	c3c50513          	addi	a0,a0,-964 # 6a38 <malloc+0xa3e>
    1e04:	00004097          	auipc	ra,0x4
    1e08:	13e080e7          	jalr	318(ra) # 5f42 <printf>
          exit(1);
    1e0c:	4505                	li	a0,1
    ...
    1e72:	d2250513          	addi	a0,a0,-734 # 6b90 <malloc+0xb96>
    1e76:	00004097          	auipc	ra,0x4
    1e7a:	0cc080e7          	jalr	204(ra) # 5f42 <printf>
            exit(1);
    1e7e:	4505                	li	a0,1
    ...
    1ea6:	d0650513          	addi	a0,a0,-762 # 6ba8 <malloc+0xbae>
    1eaa:	00004097          	auipc	ra,0x4
    1eae:	098080e7          	jalr	152(ra) # 5f42 <printf>
        exit(1);
    1eb2:	4505                	li	a0,1
    ...
    1f0c:	cc850513          	addi	a0,a0,-824 # 6bd0 <malloc+0xbd6>
    1f10:	00004097          	auipc	ra,0x4
    1f14:	032080e7          	jalr	50(ra) # 5f42 <printf>
        exit(1);
    1f18:	4505                	li	a0,1
...
0000000000001f8c <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fac:	1e050513          	addi	a0,a0,480 # 6188 <malloc+0x18e>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fe8:	1a4a8a93          	addi	s5,s5,420 # 6188 <malloc+0x18e>
      link("cat", "x");
    1fec:	00005b97          	auipc	s7,0x5
    1ff0:	c0cb8b93          	addi	s7,s7,-1012 # 6bf8 <malloc+0xbfe>
    1ff4:	a825                	j	202c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ff6:	85a6                	mv	a1,s1
    1ff8:	00005517          	auipc	a0,0x5
    1ffc:	9a850513          	addi	a0,a0,-1624 # 69a0 <malloc+0x9a6>
    2000:	00004097          	auipc	ra,0x4
    2004:	f42080e7          	jalr	-190(ra) # 5f42 <printf>
    exit(1);
    2008:	4505                	li	a0,1
...
000000000000208e <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20be:	b5e50513          	addi	a0,a0,-1186 # 6c18 <malloc+0xc1e>
    20c2:	00004097          	auipc	ra,0x4
    20c6:	e80080e7          	jalr	-384(ra) # 5f42 <printf>
    exit(1);
    20ca:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    2120:	ae450513          	addi	a0,a0,-1308 # 6c00 <malloc+0xc06>
    2124:	00004097          	auipc	ra,0x4
    2128:	e1e080e7          	jalr	-482(ra) # 5f42 <printf>
    exit(1);
    212c:	4505                	li	a0,1
    ...
    213c:	b0850513          	addi	a0,a0,-1272 # 6c40 <malloc+0xc46>
    2140:	00004097          	auipc	ra,0x4
    2144:	e02080e7          	jalr	-510(ra) # 5f42 <printf>
      exit(1);
    2148:	4505                	li	a0,1
    ...
    2158:	b0450513          	addi	a0,a0,-1276 # 6c58 <malloc+0xc5e>
    215c:	00004097          	auipc	ra,0x4
    2160:	de6080e7          	jalr	-538(ra) # 5f42 <printf>
    exit(1);
    2164:	4505                	li	a0,1
...
000000000000216e <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    218a:	35098993          	addi	s3,s3,848 # c350 <uninit+0x1df8>
    218e:	1003d937          	lui	s2,0x1003d
    2192:	090e                	slli	s2,s2,0x3
    2194:	48090913          	addi	s2,s2,1152 # 1003d480 <base+0x1002d818>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21d8:	7cc50513          	addi	a0,a0,1996 # 69a0 <malloc+0x9a6>
    21dc:	00004097          	auipc	ra,0x4
    21e0:	d66080e7          	jalr	-666(ra) # 5f42 <printf>
      exit(1);
    21e4:	4505                	li	a0,1
    ...
    21fa:	a7a50513          	addi	a0,a0,-1414 # 6c70 <malloc+0xc76>
    21fe:	00004097          	auipc	ra,0x4
    2202:	d44080e7          	jalr	-700(ra) # 5f42 <printf>
      exit(1);
    2206:	4505                	li	a0,1
...
000000000000221a <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    227c:	72850513          	addi	a0,a0,1832 # 69a0 <malloc+0x9a6>
    2280:	00004097          	auipc	ra,0x4
    2284:	cc2080e7          	jalr	-830(ra) # 5f42 <printf>
      exit(1);
    2288:	4505                	li	a0,1
    ...
    22a8:	9ec50513          	addi	a0,a0,-1556 # 6c90 <malloc+0xc96>
    22ac:	00004097          	auipc	ra,0x4
    22b0:	c96080e7          	jalr	-874(ra) # 5f42 <printf>
      exit(1);
    22b4:	4505                	li	a0,1
...
00000000000022c8 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22d8:	9d450513          	addi	a0,a0,-1580 # 6ca8 <malloc+0xcae>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230a:	9a250513          	addi	a0,a0,-1630 # 6ca8 <malloc+0xcae>
  ...
  close(fd);
    ...
    2330:	12478793          	addi	a5,a5,292 # 9450 <args.1>
    2334:	00007697          	auipc	a3,0x7
    2338:	21468693          	addi	a3,a3,532 # 9548 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    233c:	00005717          	auipc	a4,0x5
    2340:	97c70713          	addi	a4,a4,-1668 # 6cb8 <malloc+0xcbe>
    ...
    2394:	a0850513          	addi	a0,a0,-1528 # 6d98 <malloc+0xd9e>
    2398:	00004097          	auipc	ra,0x4
    239c:	baa080e7          	jalr	-1110(ra) # 5f42 <printf>
    exit(1);
    23a0:	4505                	li	a0,1
    ...
    23b8:	a0450513          	addi	a0,a0,-1532 # 6db8 <malloc+0xdbe>
    23bc:	00004097          	auipc	ra,0x4
    23c0:	b86080e7          	jalr	-1146(ra) # 5f42 <printf>
    exit(1);
    23c4:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2416:	9c650513          	addi	a0,a0,-1594 # 6dd8 <malloc+0xdde>
    241a:	00004097          	auipc	ra,0x4
    241e:	b28080e7          	jalr	-1240(ra) # 5f42 <printf>
    exit(1);
    2422:	4505                	li	a0,1
    ...
    2432:	57250513          	addi	a0,a0,1394 # 69a0 <malloc+0x9a6>
    2436:	00004097          	auipc	ra,0x4
    243a:	b0c080e7          	jalr	-1268(ra) # 5f42 <printf>
    exit(1);
    243e:	4505                	li	a0,1
...
0000000000002452 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a0:	50450513          	addi	a0,a0,1284 # 69a0 <malloc+0x9a6>
    24a4:	00004097          	auipc	ra,0x4
    24a8:	a9e080e7          	jalr	-1378(ra) # 5f42 <printf>
    exit(1);
    24ac:	4505                	li	a0,1
...
00000000000024c0 <manywrites>:
{
  ...
  exit(0);
    ...
    251c:	89050513          	addi	a0,a0,-1904 # 6da8 <malloc+0xdae>
    2520:	00004097          	auipc	ra,0x4
    2524:	a22080e7          	jalr	-1502(ra) # 5f42 <printf>
      exit(1);
    2528:	4505                	li	a0,1
    ...
    2558:	714b0b13          	addi	s6,s6,1812 # cc68 <buf>
    ...
    25cc:	83850513          	addi	a0,a0,-1992 # 6e00 <malloc+0xe06>
    25d0:	00004097          	auipc	ra,0x4
    25d4:	972080e7          	jalr	-1678(ra) # 5f42 <printf>
            exit(1);
    25d8:	4505                	li	a0,1
    ...
    25ec:	c0050513          	addi	a0,a0,-1024 # 61e8 <malloc+0x1ee>
    25f0:	00004097          	auipc	ra,0x4
    25f4:	952080e7          	jalr	-1710(ra) # 5f42 <printf>
            exit(1);
    25f8:	4505                	li	a0,1
...
000000000000260a <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2684:	47878793          	addi	a5,a5,1144 # 7af8 <malloc+0x1afe>
  ...
  if(ret != -1){
    ...
    26c6:	75650513          	addi	a0,a0,1878 # 6e18 <malloc+0xe1e>
    26ca:	00004097          	auipc	ra,0x4
    26ce:	878080e7          	jalr	-1928(ra) # 5f42 <printf>
    exit(1);
    26d2:	4505                	li	a0,1
    ...
    26e4:	1e050513          	addi	a0,a0,480 # 68c0 <malloc+0x8c6>
    26e8:	00004097          	auipc	ra,0x4
    26ec:	85a080e7          	jalr	-1958(ra) # 5f42 <printf>
    exit(1);
    26f0:	4505                	li	a0,1
    ...
    2702:	1e250513          	addi	a0,a0,482 # 68e0 <malloc+0x8e6>
    2706:	00004097          	auipc	ra,0x4
    270a:	83c080e7          	jalr	-1988(ra) # 5f42 <printf>
    exit(1);
    270e:	4505                	li	a0,1
    ...
    2722:	1e250513          	addi	a0,a0,482 # 6900 <malloc+0x906>
    2726:	00004097          	auipc	ra,0x4
    272a:	81c080e7          	jalr	-2020(ra) # 5f42 <printf>
    exit(1);
    272e:	4505                	li	a0,1
    ...
    2740:	1ec50513          	addi	a0,a0,492 # 6928 <malloc+0x92e>
    2744:	00003097          	auipc	ra,0x3
    2748:	7fe080e7          	jalr	2046(ra) # 5f42 <printf>
    exit(1);
    274c:	4505                	li	a0,1
...
0000000000002756 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    278c:	6d050513          	addi	a0,a0,1744 # 6e58 <malloc+0xe5e>
  ...
  if(n >= 0){
    ...
    27bc:	6c050513          	addi	a0,a0,1728 # 6e78 <malloc+0xe7e>
    27c0:	00003097          	auipc	ra,0x3
    27c4:	782080e7          	jalr	1922(ra) # 5f42 <printf>
    exit(1);
    27c8:	4505                	li	a0,1
    ...
    27d6:	64e50513          	addi	a0,a0,1614 # 6e20 <malloc+0xe26>
    27da:	00003097          	auipc	ra,0x3
    27de:	768080e7          	jalr	1896(ra) # 5f42 <printf>
    exit(1);
    27e2:	4505                	li	a0,1
    ...
    27f0:	64c50513          	addi	a0,a0,1612 # 6e38 <malloc+0xe3e>
    27f4:	00003097          	auipc	ra,0x3
    27f8:	74e080e7          	jalr	1870(ra) # 5f42 <printf>
    exit(1);
    27fc:	4505                	li	a0,1
    ...
    280a:	65a50513          	addi	a0,a0,1626 # 6e60 <malloc+0xe66>
    280e:	00003097          	auipc	ra,0x3
    2812:	734080e7          	jalr	1844(ra) # 5f42 <printf>
    exit(1);
    2816:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    282e:	62e50513          	addi	a0,a0,1582 # 6e58 <malloc+0xe5e>
    2832:	00003097          	auipc	ra,0x3
    2836:	3de080e7          	jalr	990(ra) # 5c10 <unlink>
  fd = open("README", O_RDONLY);
    283a:	4581                	li	a1,0
    283c:	00004517          	auipc	a0,0x4
    2840:	ab450513          	addi	a0,a0,-1356 # 62f0 <malloc+0x2f6>
  ...
  if(n >= 0){
    ...
    286a:	64250513          	addi	a0,a0,1602 # 6ea8 <malloc+0xeae>
    286e:	00003097          	auipc	ra,0x3
    2872:	6d4080e7          	jalr	1748(ra) # 5f42 <printf>
    exit(1);
    2876:	4505                	li	a0,1
    ...
    2884:	5e050513          	addi	a0,a0,1504 # 6e60 <malloc+0xe66>
    2888:	00003097          	auipc	ra,0x3
    288c:	6ba080e7          	jalr	1722(ra) # 5f42 <printf>
    exit(1);
    2890:	4505                	li	a0,1
...
00000000000028ae <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    28ea:	6705                	lui	a4,0x1
      *b = 99;
    28ec:	00d50023          	sb	a3,0(a0) # 40000000 <base+0x3fff0398>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    2904:	5d050513          	addi	a0,a0,1488 # 6ed0 <malloc+0xed6>
    2908:	00003097          	auipc	ra,0x3
    290c:	63a080e7          	jalr	1594(ra) # 5f42 <printf>
    exit(1);
    2910:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2956:	59e50513          	addi	a0,a0,1438 # 6ef0 <malloc+0xef6>
    295a:	00003097          	auipc	ra,0x3
    295e:	5e8080e7          	jalr	1512(ra) # 5f42 <printf>
    exit(1);
    2962:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    29ba:	59a50513          	addi	a0,a0,1434 # 6f50 <malloc+0xf56>
    29be:	00003097          	auipc	ra,0x3
    29c2:	584080e7          	jalr	1412(ra) # 5f42 <printf>
    exit(1);
    29c6:	4505                	li	a0,1
    ...
    29dc:	53850513          	addi	a0,a0,1336 # 6f10 <malloc+0xf16>
    29e0:	00003097          	auipc	ra,0x3
    29e4:	562080e7          	jalr	1378(ra) # 5f42 <printf>
      exit(1);
    29e8:	4505                	li	a0,1
    ...
    29f8:	53c50513          	addi	a0,a0,1340 # 6f30 <malloc+0xf36>
    29fc:	00003097          	auipc	ra,0x3
    2a00:	546080e7          	jalr	1350(ra) # 5f42 <printf>
    exit(1);
    2a04:	4505                	li	a0,1
...
0000000000002a34 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2a96:	fee78fa3          	sb	a4,-1(a5) # 63fffff <base+0x63f0397>
  a = sbrk(0);
    2a9a:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    2afa:	fff7c703          	lbu	a4,-1(a5) # 63fffff <base+0x63f0397>
  ...
  if(c != a){
    ...
    2b42:	43250513          	addi	a0,a0,1074 # 6f70 <malloc+0xf76>
    2b46:	00003097          	auipc	ra,0x3
    2b4a:	3fc080e7          	jalr	1020(ra) # 5f42 <printf>
    exit(1);
    2b4e:	4505                	li	a0,1
    ...
    2b5e:	45e50513          	addi	a0,a0,1118 # 6fb8 <malloc+0xfbe>
    2b62:	00003097          	auipc	ra,0x3
    2b66:	3e0080e7          	jalr	992(ra) # 5f42 <printf>
    exit(1);
    2b6a:	4505                	li	a0,1
    ...
    2b7e:	45e50513          	addi	a0,a0,1118 # 6fd8 <malloc+0xfde>
    2b82:	00003097          	auipc	ra,0x3
    2b86:	3c0080e7          	jalr	960(ra) # 5f42 <printf>
    exit(1);
    2b8a:	4505                	li	a0,1
    ...
    2b9e:	47e50513          	addi	a0,a0,1150 # 7018 <malloc+0x101e>
    2ba2:	00003097          	auipc	ra,0x3
    2ba6:	3a0080e7          	jalr	928(ra) # 5f42 <printf>
    exit(1);
    2baa:	4505                	li	a0,1
    ...
    2bba:	49250513          	addi	a0,a0,1170 # 7048 <malloc+0x104e>
    2bbe:	00003097          	auipc	ra,0x3
    2bc2:	384080e7          	jalr	900(ra) # 5f42 <printf>
    exit(1);
    2bc6:	4505                	li	a0,1
    ...
    2bda:	4aa50513          	addi	a0,a0,1194 # 7080 <malloc+0x1086>
    2bde:	00003097          	auipc	ra,0x3
    2be2:	364080e7          	jalr	868(ra) # 5f42 <printf>
    exit(1);
    2be6:	4505                	li	a0,1
...
0000000000002bf0 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c14:	49850513          	addi	a0,a0,1176 # 70a8 <malloc+0x10ae>
    2c18:	00003097          	auipc	ra,0x3
    2c1c:	fe8080e7          	jalr	-24(ra) # 5c00 <open>
    2c20:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c22:	00004517          	auipc	a0,0x4
    2c26:	48650513          	addi	a0,a0,1158 # 70a8 <malloc+0x10ae>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c7a:	43a50513          	addi	a0,a0,1082 # 70b0 <malloc+0x10b6>
    2c7e:	00003097          	auipc	ra,0x3
    2c82:	2c4080e7          	jalr	708(ra) # 5f42 <printf>
    exit(1);
    2c86:	4505                	li	a0,1
    ...
    2c96:	43650513          	addi	a0,a0,1078 # 70c8 <malloc+0x10ce>
    2c9a:	00003097          	auipc	ra,0x3
    2c9e:	2a8080e7          	jalr	680(ra) # 5f42 <printf>
    exit(1);
    2ca2:	4505                	li	a0,1
    ...
    2cb2:	dfa50513          	addi	a0,a0,-518 # 6aa8 <malloc+0xaae>
    2cb6:	00003097          	auipc	ra,0x3
    2cba:	28c080e7          	jalr	652(ra) # 5f42 <printf>
    exit(1);
    2cbe:	4505                	li	a0,1
...
0000000000002cc8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2cdc:	40850513          	addi	a0,a0,1032 # 70e0 <malloc+0x10e6>
  ...
  close(fd);
    ...
    2d24:	c9850513          	addi	a0,a0,-872 # 69b8 <malloc+0x9be>
    2d28:	00003097          	auipc	ra,0x3
    2d2c:	21a080e7          	jalr	538(ra) # 5f42 <printf>
    exit(1);
    2d30:	4505                	li	a0,1
...
0000000000002d3a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d72:	03a50513          	addi	a0,a0,58 # 6da8 <malloc+0xdae>
    2d76:	00003097          	auipc	ra,0x3
    2d7a:	1cc080e7          	jalr	460(ra) # 5f42 <printf>
    exit(1);
    2d7e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2dc8:	fe450513          	addi	a0,a0,-28 # 6da8 <malloc+0xdae>
    2dcc:	00003097          	auipc	ra,0x3
    2dd0:	176080e7          	jalr	374(ra) # 5f42 <printf>
    exit(1);
    2dd4:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2e00:	8007879b          	addiw	a5,a5,-2048 # a800 <uninit+0x2a8>
    ...
    2e28:	f8450513          	addi	a0,a0,-124 # 6da8 <malloc+0xdae>
    2e2c:	00003097          	auipc	ra,0x3
    2e30:	116080e7          	jalr	278(ra) # 5f42 <printf>
    exit(1);
    2e34:	4505                	li	a0,1
...
0000000000002f24 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2f30:	0511                	addi	a0,a0,4 # ffffffff80000004 <base+0xffffffff7fff039c>
...
0000000000002f5a <execout>:
{
  ...
  exit(0);
    ...
    2f9c:	e1050513          	addi	a0,a0,-496 # 6da8 <malloc+0xdae>
    2fa0:	00003097          	auipc	ra,0x3
    2fa4:	fa2080e7          	jalr	-94(ra) # 5f42 <printf>
      exit(1);
    2fa8:	4505                	li	a0,1
    ...
    2ff0:	12c50513          	addi	a0,a0,300 # 6118 <malloc+0x11e>
    2ff4:	faa43c23          	sd	a0,-72(s0)
    2ff8:	00003797          	auipc	a5,0x3
    2ffc:	19078793          	addi	a5,a5,400 # 6188 <malloc+0x18e>
...
000000000000301e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    302e:	28e50513          	addi	a0,a0,654 # 72b8 <malloc+0x12be>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3040:	0d450513          	addi	a0,a0,212 # 7110 <malloc+0x1116>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    3056:	11650513          	addi	a0,a0,278 # 7168 <malloc+0x116e>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    3074:	17050513          	addi	a0,a0,368 # 71e0 <malloc+0x11e6>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3090:	1c450513          	addi	a0,a0,452 # 7250 <malloc+0x1256>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a2:	20a50513          	addi	a0,a0,522 # 72a8 <malloc+0x12ae>
  ...
  unlink("12345678901234");
    ...
    3120:	fcc50513          	addi	a0,a0,-52 # 70e8 <malloc+0x10ee>
    3124:	00003097          	auipc	ra,0x3
    3128:	e1e080e7          	jalr	-482(ra) # 5f42 <printf>
    exit(1);
    312c:	4505                	li	a0,1
    ...
    313c:	ff850513          	addi	a0,a0,-8 # 7130 <malloc+0x1136>
    3140:	00003097          	auipc	ra,0x3
    3144:	e02080e7          	jalr	-510(ra) # 5f42 <printf>
    exit(1);
    3148:	4505                	li	a0,1
    ...
    3158:	04450513          	addi	a0,a0,68 # 7198 <malloc+0x119e>
    315c:	00003097          	auipc	ra,0x3
    3160:	de6080e7          	jalr	-538(ra) # 5f42 <printf>
    exit(1);
    3164:	4505                	li	a0,1
    ...
    3174:	0a050513          	addi	a0,a0,160 # 7210 <malloc+0x1216>
    3178:	00003097          	auipc	ra,0x3
    317c:	dca080e7          	jalr	-566(ra) # 5f42 <printf>
    exit(1);
    3180:	4505                	li	a0,1
    ...
    3190:	0e450513          	addi	a0,a0,228 # 7270 <malloc+0x1276>
    3194:	00003097          	auipc	ra,0x3
    3198:	dae080e7          	jalr	-594(ra) # 5f42 <printf>
    exit(1);
    319c:	4505                	li	a0,1
    ...
    31ac:	12050513          	addi	a0,a0,288 # 72c8 <malloc+0x12ce>
    31b0:	00003097          	auipc	ra,0x3
    31b4:	d92080e7          	jalr	-622(ra) # 5f42 <printf>
    exit(1);
    31b8:	4505                	li	a0,1
...
00000000000031c2 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31f8:	10c50513          	addi	a0,a0,268 # 7300 <malloc+0x1306>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3222:	0f250513          	addi	a0,a0,242 # 7310 <malloc+0x1316>
    3226:	00003097          	auipc	ra,0x3
    322a:	d1c080e7          	jalr	-740(ra) # 5f42 <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b2:	05250513          	addi	a0,a0,82 # 7300 <malloc+0x1306>
  ...
  unlink("diskfulldir");
    ...
    32c6:	03e50513          	addi	a0,a0,62 # 7300 <malloc+0x1306>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33f4:	f4050513          	addi	a0,a0,-192 # 7330 <malloc+0x1336>
    33f8:	00003097          	auipc	ra,0x3
    33fc:	b4a080e7          	jalr	-1206(ra) # 5f42 <printf>
...
0000000000003402 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3412:	f5250513          	addi	a0,a0,-174 # 7360 <malloc+0x1366>
  ...
  if(chdir("iputdir") < 0){
    ...
    3426:	f3e50513          	addi	a0,a0,-194 # 7360 <malloc+0x1366>
  ...
  if(unlink("../iputdir") < 0){
    ...
    343a:	f6a50513          	addi	a0,a0,-150 # 73a0 <malloc+0x13a6>
  ...
  if(chdir("/") < 0){
    ...
    344e:	f8650513          	addi	a0,a0,-122 # 73d0 <malloc+0x13d6>
    ...
    346e:	efe50513          	addi	a0,a0,-258 # 7368 <malloc+0x136e>
    3472:	00003097          	auipc	ra,0x3
    3476:	ad0080e7          	jalr	-1328(ra) # 5f42 <printf>
    exit(1);
    347a:	4505                	li	a0,1
    ...
    348a:	efa50513          	addi	a0,a0,-262 # 7380 <malloc+0x1386>
    348e:	00003097          	auipc	ra,0x3
    3492:	ab4080e7          	jalr	-1356(ra) # 5f42 <printf>
    exit(1);
    3496:	4505                	li	a0,1
    ...
    34a6:	f0e50513          	addi	a0,a0,-242 # 73b0 <malloc+0x13b6>
    34aa:	00003097          	auipc	ra,0x3
    34ae:	a98080e7          	jalr	-1384(ra) # 5f42 <printf>
    exit(1);
    34b2:	4505                	li	a0,1
    ...
    34c2:	f1a50513          	addi	a0,a0,-230 # 73d8 <malloc+0x13de>
    34c6:	00003097          	auipc	ra,0x3
    34ca:	a7c080e7          	jalr	-1412(ra) # 5f42 <printf>
    exit(1);
    34ce:	4505                	li	a0,1
...
00000000000034d8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34f6:	e6e50513          	addi	a0,a0,-402 # 7360 <malloc+0x1366>
    ...
    350a:	e5a50513          	addi	a0,a0,-422 # 7360 <malloc+0x1366>
    ...
    351e:	e8650513          	addi	a0,a0,-378 # 73a0 <malloc+0x13a6>
    ...
    353e:	46650513          	addi	a0,a0,1126 # 69a0 <malloc+0x9a6>
    3542:	00003097          	auipc	ra,0x3
    3546:	a00080e7          	jalr	-1536(ra) # 5f42 <printf>
    exit(1);
    354a:	4505                	li	a0,1
    ...
    355a:	e1250513          	addi	a0,a0,-494 # 7368 <malloc+0x136e>
    355e:	00003097          	auipc	ra,0x3
    3562:	9e4080e7          	jalr	-1564(ra) # 5f42 <printf>
      exit(1);
    3566:	4505                	li	a0,1
    ...
    3576:	e7e50513          	addi	a0,a0,-386 # 73f0 <malloc+0x13f6>
    357a:	00003097          	auipc	ra,0x3
    357e:	9c8080e7          	jalr	-1592(ra) # 5f42 <printf>
      exit(1);
    3582:	4505                	li	a0,1
    ...
    3592:	e2250513          	addi	a0,a0,-478 # 73b0 <malloc+0x13b6>
    3596:	00003097          	auipc	ra,0x3
    359a:	9ac080e7          	jalr	-1620(ra) # 5f42 <printf>
      exit(1);
    359e:	4505                	li	a0,1
...
00000000000035c0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d0:	e3c50513          	addi	a0,a0,-452 # 7408 <malloc+0x140e>
  ...
  if(chdir("dir0") < 0){
    ...
    35e4:	e2850513          	addi	a0,a0,-472 # 7408 <malloc+0x140e>
  ...
  if(chdir("..") < 0){
    ...
    35f8:	e3450513          	addi	a0,a0,-460 # 7428 <malloc+0x142e>
  ...
  if(unlink("dir0") < 0){
    ...
    360c:	e0050513          	addi	a0,a0,-512 # 7408 <malloc+0x140e>
    ...
    362c:	d4050513          	addi	a0,a0,-704 # 7368 <malloc+0x136e>
    3630:	00003097          	auipc	ra,0x3
    3634:	912080e7          	jalr	-1774(ra) # 5f42 <printf>
    exit(1);
    3638:	4505                	li	a0,1
    ...
    3648:	dcc50513          	addi	a0,a0,-564 # 7410 <malloc+0x1416>
    364c:	00003097          	auipc	ra,0x3
    3650:	8f6080e7          	jalr	-1802(ra) # 5f42 <printf>
    exit(1);
    3654:	4505                	li	a0,1
    ...
    3664:	dd050513          	addi	a0,a0,-560 # 7430 <malloc+0x1436>
    3668:	00003097          	auipc	ra,0x3
    366c:	8da080e7          	jalr	-1830(ra) # 5f42 <printf>
    exit(1);
    3670:	4505                	li	a0,1
    ...
    3680:	dcc50513          	addi	a0,a0,-564 # 7448 <malloc+0x144e>
    3684:	00003097          	auipc	ra,0x3
    3688:	8be080e7          	jalr	-1858(ra) # 5f42 <printf>
    exit(1);
    368c:	4505                	li	a0,1
...
0000000000003696 <subdir>:
{
  ...
  unlink("ff");
    ...
    36a8:	eec50513          	addi	a0,a0,-276 # 7590 <malloc+0x1596>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	564080e7          	jalr	1380(ra) # 5c10 <unlink>
  if(mkdir("dd") != 0){
    36b4:	00004517          	auipc	a0,0x4
    36b8:	dac50513          	addi	a0,a0,-596 # 7460 <malloc+0x1466>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d0:	db450513          	addi	a0,a0,-588 # 7480 <malloc+0x1486>
  ...
  write(fd, "ff", 2);
    ...
    36e8:	eac58593          	addi	a1,a1,-340 # 7590 <malloc+0x1596>
  ...
  if(unlink("dd") >= 0){
    ...
    3702:	d6250513          	addi	a0,a0,-670 # 7460 <malloc+0x1466>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3716:	dc650513          	addi	a0,a0,-570 # 74d8 <malloc+0x14de>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    372e:	dd650513          	addi	a0,a0,-554 # 7500 <malloc+0x1506>
  ...
  write(fd, "FF", 2);
    ...
    3746:	dee58593          	addi	a1,a1,-530 # 7530 <malloc+0x1536>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3762:	dda50513          	addi	a0,a0,-550 # 7538 <malloc+0x153e>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3790:	4dc74703          	lbu	a4,1244(a4) # cc68 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37aa:	de258593          	addi	a1,a1,-542 # 7588 <malloc+0x158e>
    37ae:	00004517          	auipc	a0,0x4
    37b2:	d5250513          	addi	a0,a0,-686 # 7500 <malloc+0x1506>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37c6:	d3e50513          	addi	a0,a0,-706 # 7500 <malloc+0x1506>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37dc:	d2850513          	addi	a0,a0,-728 # 7500 <malloc+0x1506>
  ...
  if(chdir("dd") != 0){
    ...
    37f0:	c7450513          	addi	a0,a0,-908 # 7460 <malloc+0x1466>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3804:	e2050513          	addi	a0,a0,-480 # 7620 <malloc+0x1626>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3818:	e3c50513          	addi	a0,a0,-452 # 7650 <malloc+0x1656>
  ...
  if(chdir("./..") != 0){
    ...
    382c:	e5850513          	addi	a0,a0,-424 # 7680 <malloc+0x1686>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3842:	d4a50513          	addi	a0,a0,-694 # 7588 <malloc+0x158e>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    385a:	41258593          	addi	a1,a1,1042 # cc68 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    387c:	c8850513          	addi	a0,a0,-888 # 7500 <malloc+0x1506>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3894:	e8050513          	addi	a0,a0,-384 # 7710 <malloc+0x1716>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38ac:	e9850513          	addi	a0,a0,-360 # 7740 <malloc+0x1746>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38c4:	ba050513          	addi	a0,a0,-1120 # 7460 <malloc+0x1466>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38da:	b8a50513          	addi	a0,a0,-1142 # 7460 <malloc+0x1466>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f0:	b7450513          	addi	a0,a0,-1164 # 7460 <malloc+0x1466>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3904:	ed058593          	addi	a1,a1,-304 # 77d0 <malloc+0x17d6>
    3908:	00004517          	auipc	a0,0x4
    390c:	e0850513          	addi	a0,a0,-504 # 7710 <malloc+0x1716>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3920:	eb458593          	addi	a1,a1,-332 # 77d0 <malloc+0x17d6>
    3924:	00004517          	auipc	a0,0x4
    3928:	e1c50513          	addi	a0,a0,-484 # 7740 <malloc+0x1746>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    393c:	c5058593          	addi	a1,a1,-944 # 7588 <malloc+0x158e>
    3940:	00004517          	auipc	a0,0x4
    3944:	b4050513          	addi	a0,a0,-1216 # 7480 <malloc+0x1486>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3958:	dbc50513          	addi	a0,a0,-580 # 7710 <malloc+0x1716>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    396c:	dd850513          	addi	a0,a0,-552 # 7740 <malloc+0x1746>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3980:	c0c50513          	addi	a0,a0,-1012 # 7588 <malloc+0x158e>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3994:	db050513          	addi	a0,a0,-592 # 7740 <malloc+0x1746>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39a8:	d6c50513          	addi	a0,a0,-660 # 7710 <malloc+0x1716>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39bc:	ac850513          	addi	a0,a0,-1336 # 7480 <malloc+0x1486>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d0:	f5450513          	addi	a0,a0,-172 # 7920 <malloc+0x1926>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39e4:	ba850513          	addi	a0,a0,-1112 # 7588 <malloc+0x158e>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39f8:	a8c50513          	addi	a0,a0,-1396 # 7480 <malloc+0x1486>
  ...
  if(unlink("dd") == 0){
    ...
    3a0c:	a5850513          	addi	a0,a0,-1448 # 7460 <malloc+0x1466>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a20:	f7450513          	addi	a0,a0,-140 # 7990 <malloc+0x1996>
  ...
  if(unlink("dd") < 0){
    ...
    3a34:	a3050513          	addi	a0,a0,-1488 # 7460 <malloc+0x1466>
    ...
    3a56:	a1650513          	addi	a0,a0,-1514 # 7468 <malloc+0x146e>
    3a5a:	00002097          	auipc	ra,0x2
    3a5e:	4e8080e7          	jalr	1256(ra) # 5f42 <printf>
    exit(1);
    3a62:	4505                	li	a0,1
    ...
    3a72:	a1a50513          	addi	a0,a0,-1510 # 7488 <malloc+0x148e>
    3a76:	00002097          	auipc	ra,0x2
    3a7a:	4cc080e7          	jalr	1228(ra) # 5f42 <printf>
    exit(1);
    3a7e:	4505                	li	a0,1
    ...
    3a8e:	a1e50513          	addi	a0,a0,-1506 # 74a8 <malloc+0x14ae>
    3a92:	00002097          	auipc	ra,0x2
    3a96:	4b0080e7          	jalr	1200(ra) # 5f42 <printf>
    exit(1);
    3a9a:	4505                	li	a0,1
    ...
    3aaa:	a3a50513          	addi	a0,a0,-1478 # 74e0 <malloc+0x14e6>
    3aae:	00002097          	auipc	ra,0x2
    3ab2:	494080e7          	jalr	1172(ra) # 5f42 <printf>
    exit(1);
    3ab6:	4505                	li	a0,1
    ...
    3ac6:	a4e50513          	addi	a0,a0,-1458 # 7510 <malloc+0x1516>
    3aca:	00002097          	auipc	ra,0x2
    3ace:	478080e7          	jalr	1144(ra) # 5f42 <printf>
    exit(1);
    3ad2:	4505                	li	a0,1
    ...
    3ae2:	a6a50513          	addi	a0,a0,-1430 # 7548 <malloc+0x154e>
    3ae6:	00002097          	auipc	ra,0x2
    3aea:	45c080e7          	jalr	1116(ra) # 5f42 <printf>
    exit(1);
    3aee:	4505                	li	a0,1
    ...
    3afe:	a6e50513          	addi	a0,a0,-1426 # 7568 <malloc+0x156e>
    3b02:	00002097          	auipc	ra,0x2
    3b06:	440080e7          	jalr	1088(ra) # 5f42 <printf>
    exit(1);
    3b0a:	4505                	li	a0,1
    ...
    3b1a:	a8250513          	addi	a0,a0,-1406 # 7598 <malloc+0x159e>
    3b1e:	00002097          	auipc	ra,0x2
    3b22:	424080e7          	jalr	1060(ra) # 5f42 <printf>
    exit(1);
    3b26:	4505                	li	a0,1
    ...
    3b36:	a8e50513          	addi	a0,a0,-1394 # 75c0 <malloc+0x15c6>
    3b3a:	00002097          	auipc	ra,0x2
    3b3e:	408080e7          	jalr	1032(ra) # 5f42 <printf>
    exit(1);
    3b42:	4505                	li	a0,1
    ...
    3b52:	a9250513          	addi	a0,a0,-1390 # 75e0 <malloc+0x15e6>
    3b56:	00002097          	auipc	ra,0x2
    3b5a:	3ec080e7          	jalr	1004(ra) # 5f42 <printf>
    exit(1);
    3b5e:	4505                	li	a0,1
    ...
    3b6e:	a9e50513          	addi	a0,a0,-1378 # 7608 <malloc+0x160e>
    3b72:	00002097          	auipc	ra,0x2
    3b76:	3d0080e7          	jalr	976(ra) # 5f42 <printf>
    exit(1);
    3b7a:	4505                	li	a0,1
    ...
    3b8a:	aaa50513          	addi	a0,a0,-1366 # 7630 <malloc+0x1636>
    3b8e:	00002097          	auipc	ra,0x2
    3b92:	3b4080e7          	jalr	948(ra) # 5f42 <printf>
    exit(1);
    3b96:	4505                	li	a0,1
    ...
    3ba6:	abe50513          	addi	a0,a0,-1346 # 7660 <malloc+0x1666>
    3baa:	00002097          	auipc	ra,0x2
    3bae:	398080e7          	jalr	920(ra) # 5f42 <printf>
    exit(1);
    3bb2:	4505                	li	a0,1
    ...
    3bc2:	aca50513          	addi	a0,a0,-1334 # 7688 <malloc+0x168e>
    3bc6:	00002097          	auipc	ra,0x2
    3bca:	37c080e7          	jalr	892(ra) # 5f42 <printf>
    exit(1);
    3bce:	4505                	li	a0,1
    ...
    3bde:	ac650513          	addi	a0,a0,-1338 # 76a0 <malloc+0x16a6>
    3be2:	00002097          	auipc	ra,0x2
    3be6:	360080e7          	jalr	864(ra) # 5f42 <printf>
    exit(1);
    3bea:	4505                	li	a0,1
    ...
    3bfa:	aca50513          	addi	a0,a0,-1334 # 76c0 <malloc+0x16c6>
    3bfe:	00002097          	auipc	ra,0x2
    3c02:	344080e7          	jalr	836(ra) # 5f42 <printf>
    exit(1);
    3c06:	4505                	li	a0,1
    ...
    3c16:	ace50513          	addi	a0,a0,-1330 # 76e0 <malloc+0x16e6>
    3c1a:	00002097          	auipc	ra,0x2
    3c1e:	328080e7          	jalr	808(ra) # 5f42 <printf>
    exit(1);
    3c22:	4505                	li	a0,1
    ...
    3c32:	af250513          	addi	a0,a0,-1294 # 7720 <malloc+0x1726>
    3c36:	00002097          	auipc	ra,0x2
    3c3a:	30c080e7          	jalr	780(ra) # 5f42 <printf>
    exit(1);
    3c3e:	4505                	li	a0,1
    ...
    3c4e:	b0650513          	addi	a0,a0,-1274 # 7750 <malloc+0x1756>
    3c52:	00002097          	auipc	ra,0x2
    3c56:	2f0080e7          	jalr	752(ra) # 5f42 <printf>
    exit(1);
    3c5a:	4505                	li	a0,1
    ...
    3c6a:	b0a50513          	addi	a0,a0,-1270 # 7770 <malloc+0x1776>
    3c6e:	00002097          	auipc	ra,0x2
    3c72:	2d4080e7          	jalr	724(ra) # 5f42 <printf>
    exit(1);
    3c76:	4505                	li	a0,1
    ...
    3c86:	b0e50513          	addi	a0,a0,-1266 # 7790 <malloc+0x1796>
    3c8a:	00002097          	auipc	ra,0x2
    3c8e:	2b8080e7          	jalr	696(ra) # 5f42 <printf>
    exit(1);
    3c92:	4505                	li	a0,1
    ...
    3ca2:	b1250513          	addi	a0,a0,-1262 # 77b0 <malloc+0x17b6>
    3ca6:	00002097          	auipc	ra,0x2
    3caa:	29c080e7          	jalr	668(ra) # 5f42 <printf>
    exit(1);
    3cae:	4505                	li	a0,1
    ...
    3cbe:	b2650513          	addi	a0,a0,-1242 # 77e0 <malloc+0x17e6>
    3cc2:	00002097          	auipc	ra,0x2
    3cc6:	280080e7          	jalr	640(ra) # 5f42 <printf>
    exit(1);
    3cca:	4505                	li	a0,1
    ...
    3cda:	b3250513          	addi	a0,a0,-1230 # 7808 <malloc+0x180e>
    3cde:	00002097          	auipc	ra,0x2
    3ce2:	264080e7          	jalr	612(ra) # 5f42 <printf>
    exit(1);
    3ce6:	4505                	li	a0,1
    ...
    3cf6:	b3e50513          	addi	a0,a0,-1218 # 7830 <malloc+0x1836>
    3cfa:	00002097          	auipc	ra,0x2
    3cfe:	248080e7          	jalr	584(ra) # 5f42 <printf>
    exit(1);
    3d02:	4505                	li	a0,1
    ...
    3d12:	b4a50513          	addi	a0,a0,-1206 # 7858 <malloc+0x185e>
    3d16:	00002097          	auipc	ra,0x2
    3d1a:	22c080e7          	jalr	556(ra) # 5f42 <printf>
    exit(1);
    3d1e:	4505                	li	a0,1
    ...
    3d2e:	b4e50513          	addi	a0,a0,-1202 # 7878 <malloc+0x187e>
    3d32:	00002097          	auipc	ra,0x2
    3d36:	210080e7          	jalr	528(ra) # 5f42 <printf>
    exit(1);
    3d3a:	4505                	li	a0,1
    ...
    3d4a:	b5250513          	addi	a0,a0,-1198 # 7898 <malloc+0x189e>
    3d4e:	00002097          	auipc	ra,0x2
    3d52:	1f4080e7          	jalr	500(ra) # 5f42 <printf>
    exit(1);
    3d56:	4505                	li	a0,1
    ...
    3d66:	b5e50513          	addi	a0,a0,-1186 # 78c0 <malloc+0x18c6>
    3d6a:	00002097          	auipc	ra,0x2
    3d6e:	1d8080e7          	jalr	472(ra) # 5f42 <printf>
    exit(1);
    3d72:	4505                	li	a0,1
    ...
    3d82:	b6250513          	addi	a0,a0,-1182 # 78e0 <malloc+0x18e6>
    3d86:	00002097          	auipc	ra,0x2
    3d8a:	1bc080e7          	jalr	444(ra) # 5f42 <printf>
    exit(1);
    3d8e:	4505                	li	a0,1
    ...
    3d9e:	b6650513          	addi	a0,a0,-1178 # 7900 <malloc+0x1906>
    3da2:	00002097          	auipc	ra,0x2
    3da6:	1a0080e7          	jalr	416(ra) # 5f42 <printf>
    exit(1);
    3daa:	4505                	li	a0,1
    ...
    3dba:	b7250513          	addi	a0,a0,-1166 # 7928 <malloc+0x192e>
    3dbe:	00002097          	auipc	ra,0x2
    3dc2:	184080e7          	jalr	388(ra) # 5f42 <printf>
    exit(1);
    3dc6:	4505                	li	a0,1
    ...
    3dd6:	7ee50513          	addi	a0,a0,2030 # 75c0 <malloc+0x15c6>
    3dda:	00002097          	auipc	ra,0x2
    3dde:	168080e7          	jalr	360(ra) # 5f42 <printf>
    exit(1);
    3de2:	4505                	li	a0,1
    ...
    3df2:	b5a50513          	addi	a0,a0,-1190 # 7948 <malloc+0x194e>
    3df6:	00002097          	auipc	ra,0x2
    3dfa:	14c080e7          	jalr	332(ra) # 5f42 <printf>
    exit(1);
    3dfe:	4505                	li	a0,1
    ...
    3e0e:	b5e50513          	addi	a0,a0,-1186 # 7968 <malloc+0x196e>
    3e12:	00002097          	auipc	ra,0x2
    3e16:	130080e7          	jalr	304(ra) # 5f42 <printf>
    exit(1);
    3e1a:	4505                	li	a0,1
    ...
    3e2a:	b7250513          	addi	a0,a0,-1166 # 7998 <malloc+0x199e>
    3e2e:	00002097          	auipc	ra,0x2
    3e32:	114080e7          	jalr	276(ra) # 5f42 <printf>
    exit(1);
    3e36:	4505                	li	a0,1
    ...
    3e46:	b7650513          	addi	a0,a0,-1162 # 79b8 <malloc+0x19be>
    3e4a:	00002097          	auipc	ra,0x2
    3e4e:	0f8080e7          	jalr	248(ra) # 5f42 <printf>
    exit(1);
    3e52:	4505                	li	a0,1
...
0000000000003e5c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e6c:	b6850513          	addi	a0,a0,-1176 # 79d0 <malloc+0x19d6>
  ...
  if(chdir("dots") != 0){
    ...
    3e7e:	b5650513          	addi	a0,a0,-1194 # 79d0 <malloc+0x19d6>
  ...
  if(unlink(".") == 0){
    ...
    3e90:	97450513          	addi	a0,a0,-1676 # 6800 <malloc+0x806>
  ...
  if(unlink("..") == 0){
    ...
    3ea2:	58a50513          	addi	a0,a0,1418 # 7428 <malloc+0x142e>
  ...
  if(chdir("/") != 0){
    ...
    3eb4:	52050513          	addi	a0,a0,1312 # 73d0 <malloc+0x13d6>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ec6:	b7650513          	addi	a0,a0,-1162 # 7a38 <malloc+0x1a3e>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ed8:	b8c50513          	addi	a0,a0,-1140 # 7a60 <malloc+0x1a66>
  ...
  if(unlink("dots") != 0){
    ...
    3eea:	aea50513          	addi	a0,a0,-1302 # 79d0 <malloc+0x19d6>
    ...
    3f08:	ad450513          	addi	a0,a0,-1324 # 79d8 <malloc+0x19de>
    3f0c:	00002097          	auipc	ra,0x2
    3f10:	036080e7          	jalr	54(ra) # 5f42 <printf>
    exit(1);
    3f14:	4505                	li	a0,1
    ...
    3f24:	ad050513          	addi	a0,a0,-1328 # 79f0 <malloc+0x19f6>
    3f28:	00002097          	auipc	ra,0x2
    3f2c:	01a080e7          	jalr	26(ra) # 5f42 <printf>
    exit(1);
    3f30:	4505                	li	a0,1
    ...
    3f40:	acc50513          	addi	a0,a0,-1332 # 7a08 <malloc+0x1a0e>
    3f44:	00002097          	auipc	ra,0x2
    3f48:	ffe080e7          	jalr	-2(ra) # 5f42 <printf>
    exit(1);
    3f4c:	4505                	li	a0,1
    ...
    3f5c:	ac850513          	addi	a0,a0,-1336 # 7a20 <malloc+0x1a26>
    3f60:	00002097          	auipc	ra,0x2
    3f64:	fe2080e7          	jalr	-30(ra) # 5f42 <printf>
    exit(1);
    3f68:	4505                	li	a0,1
    ...
    3f78:	46450513          	addi	a0,a0,1124 # 73d8 <malloc+0x13de>
    3f7c:	00002097          	auipc	ra,0x2
    3f80:	fc6080e7          	jalr	-58(ra) # 5f42 <printf>
    exit(1);
    3f84:	4505                	li	a0,1
    ...
    3f94:	ab050513          	addi	a0,a0,-1360 # 7a40 <malloc+0x1a46>
    3f98:	00002097          	auipc	ra,0x2
    3f9c:	faa080e7          	jalr	-86(ra) # 5f42 <printf>
    exit(1);
    3fa0:	4505                	li	a0,1
    ...
    3fb0:	abc50513          	addi	a0,a0,-1348 # 7a68 <malloc+0x1a6e>
    3fb4:	00002097          	auipc	ra,0x2
    3fb8:	f8e080e7          	jalr	-114(ra) # 5f42 <printf>
    exit(1);
    3fbc:	4505                	li	a0,1
    ...
    3fcc:	ac050513          	addi	a0,a0,-1344 # 7a88 <malloc+0x1a8e>
    3fd0:	00002097          	auipc	ra,0x2
    3fd4:	f72080e7          	jalr	-142(ra) # 5f42 <printf>
    exit(1);
    3fd8:	4505                	li	a0,1
...
0000000000003fe2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ff8:	ab450513          	addi	a0,a0,-1356 # 7aa8 <malloc+0x1aae>
  ...
  if(chdir("dirfile") == 0){
    ...
    4014:	a9850513          	addi	a0,a0,-1384 # 7aa8 <malloc+0x1aae>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4028:	acc50513          	addi	a0,a0,-1332 # 7af0 <malloc+0x1af6>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4040:	ab450513          	addi	a0,a0,-1356 # 7af0 <malloc+0x1af6>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4054:	aa050513          	addi	a0,a0,-1376 # 7af0 <malloc+0x1af6>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4068:	a8c50513          	addi	a0,a0,-1396 # 7af0 <malloc+0x1af6>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    407c:	a7858593          	addi	a1,a1,-1416 # 7af0 <malloc+0x1af6>
    4080:	00002517          	auipc	a0,0x2
    4084:	27050513          	addi	a0,a0,624 # 62f0 <malloc+0x2f6>
  ...
  if(unlink("dirfile") != 0){
    ...
    4098:	a1450513          	addi	a0,a0,-1516 # 7aa8 <malloc+0x1aae>
  ...
  fd = open(".", O_RDWR);
    ...
    40ae:	75650513          	addi	a0,a0,1878 # 6800 <malloc+0x806>
  ...
  fd = open(".", 0);
    ...
    40c4:	74050513          	addi	a0,a0,1856 # 6800 <malloc+0x806>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40d8:	0b458593          	addi	a1,a1,180 # 6188 <malloc+0x18e>
  ...
  close(fd);
    ...
    4104:	9b050513          	addi	a0,a0,-1616 # 7ab0 <malloc+0x1ab6>
    4108:	00002097          	auipc	ra,0x2
    410c:	e3a080e7          	jalr	-454(ra) # 5f42 <printf>
    exit(1);
    4110:	4505                	li	a0,1
    ...
    4120:	9b450513          	addi	a0,a0,-1612 # 7ad0 <malloc+0x1ad6>
    4124:	00002097          	auipc	ra,0x2
    4128:	e1e080e7          	jalr	-482(ra) # 5f42 <printf>
    exit(1);
    412c:	4505                	li	a0,1
    ...
    413c:	9c850513          	addi	a0,a0,-1592 # 7b00 <malloc+0x1b06>
    4140:	00002097          	auipc	ra,0x2
    4144:	e02080e7          	jalr	-510(ra) # 5f42 <printf>
    exit(1);
    4148:	4505                	li	a0,1
    ...
    4158:	9ac50513          	addi	a0,a0,-1620 # 7b00 <malloc+0x1b06>
    415c:	00002097          	auipc	ra,0x2
    4160:	de6080e7          	jalr	-538(ra) # 5f42 <printf>
    exit(1);
    4164:	4505                	li	a0,1
    ...
    4174:	9b850513          	addi	a0,a0,-1608 # 7b28 <malloc+0x1b2e>
    4178:	00002097          	auipc	ra,0x2
    417c:	dca080e7          	jalr	-566(ra) # 5f42 <printf>
    exit(1);
    4180:	4505                	li	a0,1
    ...
    4190:	9c450513          	addi	a0,a0,-1596 # 7b50 <malloc+0x1b56>
    4194:	00002097          	auipc	ra,0x2
    4198:	dae080e7          	jalr	-594(ra) # 5f42 <printf>
    exit(1);
    419c:	4505                	li	a0,1
    ...
    41ac:	9d050513          	addi	a0,a0,-1584 # 7b78 <malloc+0x1b7e>
    41b0:	00002097          	auipc	ra,0x2
    41b4:	d92080e7          	jalr	-622(ra) # 5f42 <printf>
    exit(1);
    41b8:	4505                	li	a0,1
    ...
    41c8:	9dc50513          	addi	a0,a0,-1572 # 7ba0 <malloc+0x1ba6>
    41cc:	00002097          	auipc	ra,0x2
    41d0:	d76080e7          	jalr	-650(ra) # 5f42 <printf>
    exit(1);
    41d4:	4505                	li	a0,1
    ...
    41e4:	9e050513          	addi	a0,a0,-1568 # 7bc0 <malloc+0x1bc6>
    41e8:	00002097          	auipc	ra,0x2
    41ec:	d5a080e7          	jalr	-678(ra) # 5f42 <printf>
    exit(1);
    41f0:	4505                	li	a0,1
    ...
    4200:	9ec50513          	addi	a0,a0,-1556 # 7be8 <malloc+0x1bee>
    4204:	00002097          	auipc	ra,0x2
    4208:	d3e080e7          	jalr	-706(ra) # 5f42 <printf>
    exit(1);
    420c:	4505                	li	a0,1
...
0000000000004216 <iref>:
{
    ...
    4234:	9d0a0a13          	addi	s4,s4,-1584 # 7c00 <malloc+0x1c06>
    mkdir("");
    4238:	00003497          	auipc	s1,0x3
    423c:	4d048493          	addi	s1,s1,1232 # 7708 <malloc+0x170e>
    link("README", "");
    4240:	00002a97          	auipc	s5,0x2
    4244:	0b0a8a93          	addi	s5,s5,176 # 62f0 <malloc+0x2f6>
    fd = open("xx", O_CREATE);
    4248:	00004997          	auipc	s3,0x4
    424c:	8b098993          	addi	s3,s3,-1872 # 7af8 <malloc+0x1afe>
    4250:	a891                	j	42a4 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4252:	85da                	mv	a1,s6
    4254:	00004517          	auipc	a0,0x4
    4258:	9b450513          	addi	a0,a0,-1612 # 7c08 <malloc+0x1c0e>
    425c:	00002097          	auipc	ra,0x2
    4260:	ce6080e7          	jalr	-794(ra) # 5f42 <printf>
      exit(1);
    4264:	4505                	li	a0,1
    ...
    4274:	9b050513          	addi	a0,a0,-1616 # 7c20 <malloc+0x1c26>
    4278:	00002097          	auipc	ra,0x2
    427c:	cca080e7          	jalr	-822(ra) # 5f42 <printf>
      exit(1);
    4280:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    4308:	12498993          	addi	s3,s3,292 # 7428 <malloc+0x142e>
    unlink("irefd");
    430c:	00004917          	auipc	s2,0x4
    4310:	8f490913          	addi	s2,s2,-1804 # 7c00 <malloc+0x1c06>
    chdir("..");
    4314:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4330:	0a450513          	addi	a0,a0,164 # 73d0 <malloc+0x13d6>
...
0000000000004350 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4360:	8dc50513          	addi	a0,a0,-1828 # 7c38 <malloc+0x1c3e>
  ...
  if(pid == 0){
    ...
    4384:	8b850513          	addi	a0,a0,-1864 # 7c38 <malloc+0x1c3e>
    ...
    439a:	8c250513          	addi	a0,a0,-1854 # 7c58 <malloc+0x1c5e>
    439e:	00002097          	auipc	ra,0x2
    43a2:	ba4080e7          	jalr	-1116(ra) # 5f42 <printf>
      exit(1);
    43a6:	4505                	li	a0,1
    ...
    43b6:	88e50513          	addi	a0,a0,-1906 # 7c40 <malloc+0x1c46>
    43ba:	00002097          	auipc	ra,0x2
    43be:	b88080e7          	jalr	-1144(ra) # 5f42 <printf>
    exit(1);
    43c2:	4505                	li	a0,1
    ...
    43d2:	5d250513          	addi	a0,a0,1490 # 69a0 <malloc+0x9a6>
    43d6:	00002097          	auipc	ra,0x2
    43da:	b6c080e7          	jalr	-1172(ra) # 5f42 <printf>
    exit(1);
    43de:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    4400:	83c50513          	addi	a0,a0,-1988 # 7c38 <malloc+0x1c3e>
    ...
    4414:	78050513          	addi	a0,a0,1920 # 6b90 <malloc+0xb96>
    4418:	00002097          	auipc	ra,0x2
    441c:	b2a080e7          	jalr	-1238(ra) # 5f42 <printf>
    exit(1);
    4420:	4505                	li	a0,1
...
0000000000004442 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4452:	83250513          	addi	a0,a0,-1998 # 7c80 <malloc+0x1c86>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    447e:	80650513          	addi	a0,a0,-2042 # 7c80 <malloc+0x1c86>
  ...
  sleep(10); // one second
    ...
    44b6:	6ae50513          	addi	a0,a0,1710 # 6b60 <malloc+0xb66>
    44ba:	00002097          	auipc	ra,0x2
    44be:	a88080e7          	jalr	-1400(ra) # 5f42 <printf>
    exit(1);
    44c2:	4505                	li	a0,1
    ...
    44d0:	7b448493          	addi	s1,s1,1972 # 7c80 <malloc+0x1c86>
    44d4:	4581                	li	a1,0
    44d6:	8526                	mv	a0,s1
...
0000000000004512 <killstatus>:
{
  ...
  exit(0);
    ...
    4578:	42c50513          	addi	a0,a0,1068 # 69a0 <malloc+0x9a6>
    457c:	00002097          	auipc	ra,0x2
    4580:	9c6080e7          	jalr	-1594(ra) # 5f42 <printf>
      exit(1);
    4584:	4505                	li	a0,1
    ...
    459e:	6f650513          	addi	a0,a0,1782 # 7c90 <malloc+0x1c96>
    45a2:	00002097          	auipc	ra,0x2
    45a6:	9a0080e7          	jalr	-1632(ra) # 5f42 <printf>
       exit(1);
    45aa:	4505                	li	a0,1
    45ac:	00001097          	auipc	ra,0x1
    45b0:	614080e7          	jalr	1556(ra) # 5bc0 <exit>

00000000000045b4 <reparent>:
{
    45b4:	7179                	addi	sp,sp,-48
    45b6:	f406                	sd	ra,40(sp)
    45b8:	f022                	sd	s0,32(sp)
    45ba:	ec26                	sd	s1,24(sp)
    45bc:	e84a                	sd	s2,16(sp)
    45be:	e44e                	sd	s3,8(sp)
    45c0:	e052                	sd	s4,0(sp)
    45c2:	1800                	addi	s0,sp,48
    45c4:	89aa                	mv	s3,a0
  int master_pid = getpid();
    45c6:	00001097          	auipc	ra,0x1
    45ca:	67a080e7          	jalr	1658(ra) # 5c40 <getpid>
    45ce:	8a2a                	mv	s4,a0
    45d0:	0c800913          	li	s2,200
    int pid = fork();
    45d4:	00001097          	auipc	ra,0x1
    45d8:	5e4080e7          	jalr	1508(ra) # 5bb8 <fork>
    45dc:	84aa                	mv	s1,a0
    if(pid < 0){
    45de:	02054263          	bltz	a0,4602 <reparent+0x4e>
    if(pid){
    45e2:	cd21                	beqz	a0,463a <reparent+0x86>
      if(wait(0) != pid){
    45e4:	4501                	li	a0,0
    45e6:	00001097          	auipc	ra,0x1
    45ea:	5e2080e7          	jalr	1506(ra) # 5bc8 <wait>
    45ee:	02951863          	bne	a0,s1,461e <reparent+0x6a>
  for(int i = 0; i < 200; i++){
    45f2:	397d                	addiw	s2,s2,-1
    45f4:	fe0910e3          	bnez	s2,45d4 <reparent+0x20>
  exit(0);
    45f8:	4501                	li	a0,0
    45fa:	00001097          	auipc	ra,0x1
    45fe:	5c6080e7          	jalr	1478(ra) # 5bc0 <exit>
      printf("%s: fork failed\n", s);
    4602:	85ce                	mv	a1,s3
    4604:	00002517          	auipc	a0,0x2
    4608:	39c50513          	addi	a0,a0,924 # 69a0 <malloc+0x9a6>
    460c:	00002097          	auipc	ra,0x2
    4610:	936080e7          	jalr	-1738(ra) # 5f42 <printf>
      exit(1);
    4614:	4505                	li	a0,1
    4616:	00001097          	auipc	ra,0x1
    461a:	5aa080e7          	jalr	1450(ra) # 5bc0 <exit>
        printf("%s: wait wrong pid\n", s);
    461e:	85ce                	mv	a1,s3
    4620:	00002517          	auipc	a0,0x2
    4624:	50850513          	addi	a0,a0,1288 # 6b28 <malloc+0xb2e>
    4628:	00002097          	auipc	ra,0x2
    462c:	91a080e7          	jalr	-1766(ra) # 5f42 <printf>
        exit(1);
    4630:	4505                	li	a0,1
    4632:	00001097          	auipc	ra,0x1
    4636:	58e080e7          	jalr	1422(ra) # 5bc0 <exit>
      int pid2 = fork();
    463a:	00001097          	auipc	ra,0x1
    463e:	57e080e7          	jalr	1406(ra) # 5bb8 <fork>
      if(pid2 < 0){
    4642:	00054763          	bltz	a0,4650 <reparent+0x9c>
      exit(0);
    4646:	4501                	li	a0,0
    4648:	00001097          	auipc	ra,0x1
    464c:	578080e7          	jalr	1400(ra) # 5bc0 <exit>
        kill(master_pid);
    4650:	8552                	mv	a0,s4
    4652:	00001097          	auipc	ra,0x1
    4656:	59e080e7          	jalr	1438(ra) # 5bf0 <kill>
        exit(1);
    465a:	4505                	li	a0,1
    465c:	00001097          	auipc	ra,0x1
    4660:	564080e7          	jalr	1380(ra) # 5bc0 <exit>

0000000000004664 <sbrkfail>:
{
    4664:	7119                	addi	sp,sp,-128
    4666:	fc86                	sd	ra,120(sp)
    4668:	f8a2                	sd	s0,112(sp)
    466a:	f4a6                	sd	s1,104(sp)
    466c:	f0ca                	sd	s2,96(sp)
    466e:	ecce                	sd	s3,88(sp)
    4670:	e8d2                	sd	s4,80(sp)
    4672:	e4d6                	sd	s5,72(sp)
    4674:	0100                	addi	s0,sp,128
    4676:	8aaa                	mv	s5,a0
  if(pipe(fds) != 0){
    4678:	fb040513          	addi	a0,s0,-80
    467c:	00001097          	auipc	ra,0x1
    4680:	554080e7          	jalr	1364(ra) # 5bd0 <pipe>
    4684:	e901                	bnez	a0,4694 <sbrkfail+0x30>
    4686:	f8040493          	addi	s1,s0,-128
    468a:	fa840993          	addi	s3,s0,-88
    468e:	8926                	mv	s2,s1
    if(pids[i] != -1)
    4690:	5a7d                	li	s4,-1
    4692:	a085                	j	46f2 <sbrkfail+0x8e>
    printf("%s: pipe() failed\n", s);
    4694:	85d6                	mv	a1,s5
    4696:	00002517          	auipc	a0,0x2
    469a:	41250513          	addi	a0,a0,1042 # 6aa8 <malloc+0xaae>
    469e:	00002097          	auipc	ra,0x2
    46a2:	8a4080e7          	jalr	-1884(ra) # 5f42 <printf>
    exit(1);
    46a6:	4505                	li	a0,1
    46a8:	00001097          	auipc	ra,0x1
    46ac:	518080e7          	jalr	1304(ra) # 5bc0 <exit>
      sbrk(BIG - (uint64)sbrk(0));
    46b0:	00001097          	auipc	ra,0x1
    46b4:	598080e7          	jalr	1432(ra) # 5c48 <sbrk>
    46b8:	064007b7          	lui	a5,0x6400
    46bc:	40a7853b          	subw	a0,a5,a0
    46c0:	00001097          	auipc	ra,0x1
    46c4:	588080e7          	jalr	1416(ra) # 5c48 <sbrk>
      write(fds[1], "x", 1);
    46c8:	4605                	li	a2,1
    46ca:	00002597          	auipc	a1,0x2
    46ce:	abe58593          	addi	a1,a1,-1346 # 6188 <malloc+0x18e>
    46d2:	fb442503          	lw	a0,-76(s0)
    46d6:	00001097          	auipc	ra,0x1
    46da:	50a080e7          	jalr	1290(ra) # 5be0 <write>
      for(;;) sleep(1000);
    46de:	3e800513          	li	a0,1000
    46e2:	00001097          	auipc	ra,0x1
    46e6:	56e080e7          	jalr	1390(ra) # 5c50 <sleep>
    46ea:	bfd5                	j	46de <sbrkfail+0x7a>
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    46ec:	0911                	addi	s2,s2,4
    46ee:	03390563          	beq	s2,s3,4718 <sbrkfail+0xb4>
    if((pids[i] = fork()) == 0){
    46f2:	00001097          	auipc	ra,0x1
    46f6:	4c6080e7          	jalr	1222(ra) # 5bb8 <fork>
    46fa:	00a92023          	sw	a0,0(s2)
    46fe:	d94d                	beqz	a0,46b0 <sbrkfail+0x4c>
    if(pids[i] != -1)
    4700:	ff4506e3          	beq	a0,s4,46ec <sbrkfail+0x88>
      read(fds[0], &scratch, 1);
    4704:	4605                	li	a2,1
    4706:	faf40593          	addi	a1,s0,-81
    470a:	fb042503          	lw	a0,-80(s0)
    470e:	00001097          	auipc	ra,0x1
    4712:	4ca080e7          	jalr	1226(ra) # 5bd8 <read>
    4716:	bfd9                	j	46ec <sbrkfail+0x88>
  c = sbrk(PGSIZE);
    4718:	6505                	lui	a0,0x1
    471a:	00001097          	auipc	ra,0x1
    471e:	52e080e7          	jalr	1326(ra) # 5c48 <sbrk>
    4722:	8a2a                	mv	s4,a0
    if(pids[i] == -1)
    4724:	597d                	li	s2,-1
    4726:	a021                	j	472e <sbrkfail+0xca>
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    4728:	0491                	addi	s1,s1,4
    472a:	01348f63          	beq	s1,s3,4748 <sbrkfail+0xe4>
    if(pids[i] == -1)
    472e:	4088                	lw	a0,0(s1)
    4730:	ff250ce3          	beq	a0,s2,4728 <sbrkfail+0xc4>
    kill(pids[i]);
    4734:	00001097          	auipc	ra,0x1
    4738:	4bc080e7          	jalr	1212(ra) # 5bf0 <kill>
    wait(0);
    473c:	4501                	li	a0,0
    473e:	00001097          	auipc	ra,0x1
    4742:	48a080e7          	jalr	1162(ra) # 5bc8 <wait>
    4746:	b7cd                	j	4728 <sbrkfail+0xc4>
  if(c == (char*)0xffffffffffffffffL){
    4748:	57fd                	li	a5,-1
    474a:	04fa0163          	beq	s4,a5,478c <sbrkfail+0x128>
  pid = fork();
    474e:	00001097          	auipc	ra,0x1
    4752:	46a080e7          	jalr	1130(ra) # 5bb8 <fork>
    4756:	84aa                	mv	s1,a0
  if(pid < 0){
    4758:	04054863          	bltz	a0,47a8 <sbrkfail+0x144>
  if(pid == 0){
    475c:	c525                	beqz	a0,47c4 <sbrkfail+0x160>
  wait(&xstatus);
    475e:	fbc40513          	addi	a0,s0,-68
    4762:	00001097          	auipc	ra,0x1
    4766:	466080e7          	jalr	1126(ra) # 5bc8 <wait>
  if(xstatus != -1 && xstatus != 2)
    476a:	fbc42783          	lw	a5,-68(s0)
    476e:	577d                	li	a4,-1
    4770:	00e78563          	beq	a5,a4,477a <sbrkfail+0x116>
    4774:	4709                	li	a4,2
    4776:	08e79d63          	bne	a5,a4,4810 <sbrkfail+0x1ac>
}
    477a:	70e6                	ld	ra,120(sp)
    477c:	7446                	ld	s0,112(sp)
    477e:	74a6                	ld	s1,104(sp)
    4780:	7906                	ld	s2,96(sp)
    4782:	69e6                	ld	s3,88(sp)
    4784:	6a46                	ld	s4,80(sp)
    4786:	6aa6                	ld	s5,72(sp)
    4788:	6109                	addi	sp,sp,128
    478a:	8082                	ret
    printf("%s: failed sbrk leaked memory\n", s);
    478c:	85d6                	mv	a1,s5
    478e:	00003517          	auipc	a0,0x3
    4792:	52250513          	addi	a0,a0,1314 # 7cb0 <malloc+0x1cb6>
    4796:	00001097          	auipc	ra,0x1
    479a:	7ac080e7          	jalr	1964(ra) # 5f42 <printf>
    exit(1);
    479e:	4505                	li	a0,1
    47a0:	00001097          	auipc	ra,0x1
    47a4:	420080e7          	jalr	1056(ra) # 5bc0 <exit>
    printf("%s: fork failed\n", s);
    47a8:	85d6                	mv	a1,s5
    47aa:	00002517          	auipc	a0,0x2
    47ae:	1f650513          	addi	a0,a0,502 # 69a0 <malloc+0x9a6>
    47b2:	00001097          	auipc	ra,0x1
    47b6:	790080e7          	jalr	1936(ra) # 5f42 <printf>
    exit(1);
    47ba:	4505                	li	a0,1
    47bc:	00001097          	auipc	ra,0x1
    47c0:	404080e7          	jalr	1028(ra) # 5bc0 <exit>
    a = sbrk(0);
    47c4:	4501                	li	a0,0
    47c6:	00001097          	auipc	ra,0x1
    47ca:	482080e7          	jalr	1154(ra) # 5c48 <sbrk>
    47ce:	892a                	mv	s2,a0
    sbrk(10*BIG);
    47d0:	3e800537          	lui	a0,0x3e800
    47d4:	00001097          	auipc	ra,0x1
    47d8:	474080e7          	jalr	1140(ra) # 5c48 <sbrk>
    for (i = 0; i < 10*BIG; i += PGSIZE) {
    47dc:	87ca                	mv	a5,s2
    47de:	3e800737          	lui	a4,0x3e800
    47e2:	993a                	add	s2,s2,a4
    47e4:	6705                	lui	a4,0x1
      n += *(a+i);
    47e6:	0007c683          	lbu	a3,0(a5) # 6400000 <base+0x63f0398>
    47ea:	9cb5                	addw	s1,s1,a3
    for (i = 0; i < 10*BIG; i += PGSIZE) {
    47ec:	97ba                	add	a5,a5,a4
    47ee:	ff279ce3          	bne	a5,s2,47e6 <sbrkfail+0x182>
    printf("%s: allocate a lot of memory succeeded %d\n", s, n);
    47f2:	8626                	mv	a2,s1
    47f4:	85d6                	mv	a1,s5
    47f6:	00003517          	auipc	a0,0x3
    47fa:	4da50513          	addi	a0,a0,1242 # 7cd0 <malloc+0x1cd6>
    47fe:	00001097          	auipc	ra,0x1
    4802:	744080e7          	jalr	1860(ra) # 5f42 <printf>
    exit(1);
    4806:	4505                	li	a0,1
    4808:	00001097          	auipc	ra,0x1
    480c:	3b8080e7          	jalr	952(ra) # 5bc0 <exit>
    exit(1);
    4810:	4505                	li	a0,1
    4812:	00001097          	auipc	ra,0x1
    4816:	3ae080e7          	jalr	942(ra) # 5bc0 <exit>

000000000000481a <mem>:
{
    ...
    4826:	0080                	addi	s0,sp,64
    4828:	89aa                	mv	s3,a0
  if((pid = fork()) == 0){
    482a:	00001097          	auipc	ra,0x1
    482e:	38e080e7          	jalr	910(ra) # 5bb8 <fork>
    m1 = 0;
    4832:	4481                	li	s1,0
    while((m2 = malloc(10001)) != 0){
    4834:	6909                	lui	s2,0x2
    4836:	71190913          	addi	s2,s2,1809 # 2711 <copyinstr3+0x107>
  if((pid = fork()) == 0){
    483a:	c115                	beqz	a0,485e <mem+0x44>
    wait(&xstatus);
    483c:	fcc40513          	addi	a0,s0,-52
    4840:	00001097          	auipc	ra,0x1
    4844:	388080e7          	jalr	904(ra) # 5bc8 <wait>
    if(xstatus == -1){
    4848:	fcc42503          	lw	a0,-52(s0)
    484c:	57fd                	li	a5,-1
    484e:	06f50363          	beq	a0,a5,48b4 <mem+0x9a>
    exit(xstatus);
    4852:	00001097          	auipc	ra,0x1
    4856:	36e080e7          	jalr	878(ra) # 5bc0 <exit>
      *(char**)m2 = m1;
    485a:	e104                	sd	s1,0(a0)
      m1 = m2;
    485c:	84aa                	mv	s1,a0
    while((m2 = malloc(10001)) != 0){
    485e:	854a                	mv	a0,s2
    4860:	00001097          	auipc	ra,0x1
    4864:	79a080e7          	jalr	1946(ra) # 5ffa <malloc>
    4868:	f96d                	bnez	a0,485a <mem+0x40>
    while(m1){
    486a:	c881                	beqz	s1,487a <mem+0x60>
      m2 = *(char**)m1;
    486c:	8526                	mv	a0,s1
    486e:	6084                	ld	s1,0(s1)
      free(m1);
    4870:	00001097          	auipc	ra,0x1
    4874:	708080e7          	jalr	1800(ra) # 5f78 <free>
    while(m1){
    4878:	f8f5                	bnez	s1,486c <mem+0x52>
    m1 = malloc(1024*20);
    487a:	6515                	lui	a0,0x5
    487c:	00001097          	auipc	ra,0x1
    4880:	77e080e7          	jalr	1918(ra) # 5ffa <malloc>
    if(m1 == 0){
    4884:	c911                	beqz	a0,4898 <mem+0x7e>
    free(m1);
    4886:	00001097          	auipc	ra,0x1
    488a:	6f2080e7          	jalr	1778(ra) # 5f78 <free>
    exit(0);
    488e:	4501                	li	a0,0
    4890:	00001097          	auipc	ra,0x1
    4894:	330080e7          	jalr	816(ra) # 5bc0 <exit>
      printf("couldn't allocate mem?!!\n", s);
    4898:	85ce                	mv	a1,s3
    489a:	00003517          	auipc	a0,0x3
    489e:	46650513          	addi	a0,a0,1126 # 7d00 <malloc+0x1d06>
    48a2:	00001097          	auipc	ra,0x1
    48a6:	6a0080e7          	jalr	1696(ra) # 5f42 <printf>
      exit(1);
    48aa:	4505                	li	a0,1
    48ac:	00001097          	auipc	ra,0x1
    48b0:	314080e7          	jalr	788(ra) # 5bc0 <exit>
      exit(0);
    48b4:	4501                	li	a0,0
    48b6:	00001097          	auipc	ra,0x1
    48ba:	30a080e7          	jalr	778(ra) # 5bc0 <exit>

00000000000048be <sharedfd>:
{
    48be:	7159                	addi	sp,sp,-112
    48c0:	f486                	sd	ra,104(sp)
    48c2:	f0a2                	sd	s0,96(sp)
    48c4:	eca6                	sd	s1,88(sp)
    48c6:	e8ca                	sd	s2,80(sp)
    48c8:	e4ce                	sd	s3,72(sp)
    48ca:	e0d2                	sd	s4,64(sp)
    48cc:	fc56                	sd	s5,56(sp)
    48ce:	f85a                	sd	s6,48(sp)
    48d0:	f45e                	sd	s7,40(sp)
    48d2:	1880                	addi	s0,sp,112
    48d4:	8a2a                	mv	s4,a0
  unlink("sharedfd");
    48d6:	00003517          	auipc	a0,0x3
    48da:	44a50513          	addi	a0,a0,1098 # 7d20 <malloc+0x1d26>
    48de:	00001097          	auipc	ra,0x1
    48e2:	332080e7          	jalr	818(ra) # 5c10 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    48e6:	20200593          	li	a1,514
    48ea:	00003517          	auipc	a0,0x3
    48ee:	43650513          	addi	a0,a0,1078 # 7d20 <malloc+0x1d26>
    48f2:	00001097          	auipc	ra,0x1
    48f6:	30e080e7          	jalr	782(ra) # 5c00 <open>
  if(fd < 0){
    48fa:	04054a63          	bltz	a0,494e <sharedfd+0x90>
    48fe:	892a                	mv	s2,a0
  pid = fork();
    4900:	00001097          	auipc	ra,0x1
    4904:	2b8080e7          	jalr	696(ra) # 5bb8 <fork>
    4908:	89aa                	mv	s3,a0
  memset(buf, pid==0?'c':'p', sizeof(buf));
    490a:	06300593          	li	a1,99
    490e:	c119                	beqz	a0,4914 <sharedfd+0x56>
    4910:	07000593          	li	a1,112
    4914:	4629                	li	a2,10
    4916:	fa040513          	addi	a0,s0,-96
    491a:	00001097          	auipc	ra,0x1
    491e:	0ac080e7          	jalr	172(ra) # 59c6 <memset>
    4922:	3e800493          	li	s1,1000
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
    4926:	4629                	li	a2,10
    4928:	fa040593          	addi	a1,s0,-96
    492c:	854a                	mv	a0,s2
    492e:	00001097          	auipc	ra,0x1
    4932:	2b2080e7          	jalr	690(ra) # 5be0 <write>
    4936:	47a9                	li	a5,10
    4938:	02f51963          	bne	a0,a5,496a <sharedfd+0xac>
  for(i = 0; i < N; i++){
    493c:	34fd                	addiw	s1,s1,-1
    493e:	f4e5                	bnez	s1,4926 <sharedfd+0x68>
  if(pid == 0) {
    4940:	04099363          	bnez	s3,4986 <sharedfd+0xc8>
    exit(0);
    4944:	4501                	li	a0,0
    4946:	00001097          	auipc	ra,0x1
    494a:	27a080e7          	jalr	634(ra) # 5bc0 <exit>
    printf("%s: cannot open sharedfd for writing", s);
    494e:	85d2                	mv	a1,s4
    4950:	00003517          	auipc	a0,0x3
    4954:	3e050513          	addi	a0,a0,992 # 7d30 <malloc+0x1d36>
    4958:	00001097          	auipc	ra,0x1
    495c:	5ea080e7          	jalr	1514(ra) # 5f42 <printf>
    exit(1);
    4960:	4505                	li	a0,1
    4962:	00001097          	auipc	ra,0x1
    4966:	25e080e7          	jalr	606(ra) # 5bc0 <exit>
      printf("%s: write sharedfd failed\n", s);
    496a:	85d2                	mv	a1,s4
    496c:	00003517          	auipc	a0,0x3
    4970:	3ec50513          	addi	a0,a0,1004 # 7d58 <malloc+0x1d5e>
    4974:	00001097          	auipc	ra,0x1
    4978:	5ce080e7          	jalr	1486(ra) # 5f42 <printf>
      exit(1);
    497c:	4505                	li	a0,1
    497e:	00001097          	auipc	ra,0x1
    4982:	242080e7          	jalr	578(ra) # 5bc0 <exit>
    wait(&xstatus);
    4986:	f9c40513          	addi	a0,s0,-100
    498a:	00001097          	auipc	ra,0x1
    498e:	23e080e7          	jalr	574(ra) # 5bc8 <wait>
    if(xstatus != 0)
    4992:	f9c42983          	lw	s3,-100(s0)
    4996:	00098763          	beqz	s3,49a4 <sharedfd+0xe6>
      exit(xstatus);
    499a:	854e                	mv	a0,s3
    499c:	00001097          	auipc	ra,0x1
    49a0:	224080e7          	jalr	548(ra) # 5bc0 <exit>
  close(fd);
    49a4:	854a                	mv	a0,s2
    49a6:	00001097          	auipc	ra,0x1
    49aa:	242080e7          	jalr	578(ra) # 5be8 <close>
  fd = open("sharedfd", 0);
    49ae:	4581                	li	a1,0
    49b0:	00003517          	auipc	a0,0x3
    49b4:	37050513          	addi	a0,a0,880 # 7d20 <malloc+0x1d26>
    49b8:	00001097          	auipc	ra,0x1
    49bc:	248080e7          	jalr	584(ra) # 5c00 <open>
    49c0:	8baa                	mv	s7,a0
  nc = np = 0;
    49c2:	8ace                	mv	s5,s3
  if(fd < 0){
    49c4:	02054563          	bltz	a0,49ee <sharedfd+0x130>
    49c8:	faa40913          	addi	s2,s0,-86
      if(buf[i] == 'c')
    49cc:	06300493          	li	s1,99
      if(buf[i] == 'p')
    49d0:	07000b13          	li	s6,112
  while((n = read(fd, buf, sizeof(buf))) > 0){
    49d4:	4629                	li	a2,10
    49d6:	fa040593          	addi	a1,s0,-96
    49da:	855e                	mv	a0,s7
    49dc:	00001097          	auipc	ra,0x1
    49e0:	1fc080e7          	jalr	508(ra) # 5bd8 <read>
    49e4:	02a05f63          	blez	a0,4a22 <sharedfd+0x164>
    49e8:	fa040793          	addi	a5,s0,-96
    49ec:	a01d                	j	4a12 <sharedfd+0x154>
    printf("%s: cannot open sharedfd for reading\n", s);
    49ee:	85d2                	mv	a1,s4
    49f0:	00003517          	auipc	a0,0x3
    49f4:	38850513          	addi	a0,a0,904 # 7d78 <malloc+0x1d7e>
    49f8:	00001097          	auipc	ra,0x1
    49fc:	54a080e7          	jalr	1354(ra) # 5f42 <printf>
    exit(1);
    4a00:	4505                	li	a0,1
    ...
    4a0e:	fd2783e3          	beq	a5,s2,49d4 <sharedfd+0x116>
      if(buf[i] == 'c')
    4a12:	0007c703          	lbu	a4,0(a5)
    4a16:	fe970ae3          	beq	a4,s1,4a0a <sharedfd+0x14c>
      if(buf[i] == 'p')
    4a1a:	ff6719e3          	bne	a4,s6,4a0c <sharedfd+0x14e>
        np++;
    4a1e:	2a85                	addiw	s5,s5,1
    4a20:	b7f5                	j	4a0c <sharedfd+0x14e>
  close(fd);
    4a22:	855e                	mv	a0,s7
    4a24:	00001097          	auipc	ra,0x1
    4a28:	1c4080e7          	jalr	452(ra) # 5be8 <close>
  unlink("sharedfd");
    4a2c:	00003517          	auipc	a0,0x3
    4a30:	2f450513          	addi	a0,a0,756 # 7d20 <malloc+0x1d26>
    4a34:	00001097          	auipc	ra,0x1
    4a38:	1dc080e7          	jalr	476(ra) # 5c10 <unlink>
  if(nc == N*SZ && np == N*SZ){
    4a3c:	6789                	lui	a5,0x2
    4a3e:	71078793          	addi	a5,a5,1808 # 2710 <copyinstr3+0x106>
    4a42:	00f99763          	bne	s3,a5,4a50 <sharedfd+0x192>
    4a46:	6789                	lui	a5,0x2
    4a48:	71078793          	addi	a5,a5,1808 # 2710 <copyinstr3+0x106>
    4a4c:	02fa8063          	beq	s5,a5,4a6c <sharedfd+0x1ae>
    printf("%s: nc/np test fails\n", s);
    4a50:	85d2                	mv	a1,s4
    4a52:	00003517          	auipc	a0,0x3
    4a56:	34e50513          	addi	a0,a0,846 # 7da0 <malloc+0x1da6>
    4a5a:	00001097          	auipc	ra,0x1
    4a5e:	4e8080e7          	jalr	1256(ra) # 5f42 <printf>
    exit(1);
    4a62:	4505                	li	a0,1
    4a64:	00001097          	auipc	ra,0x1
    4a68:	15c080e7          	jalr	348(ra) # 5bc0 <exit>
    exit(0);
    4a6c:	4501                	li	a0,0
    4a6e:	00001097          	auipc	ra,0x1
    4a72:	152080e7          	jalr	338(ra) # 5bc0 <exit>

0000000000004a76 <fourfiles>:
{
    4a76:	7171                	addi	sp,sp,-176
    4a78:	f506                	sd	ra,168(sp)
    4a7a:	f122                	sd	s0,160(sp)
    4a7c:	ed26                	sd	s1,152(sp)
    4a7e:	e94a                	sd	s2,144(sp)
    4a80:	e54e                	sd	s3,136(sp)
    4a82:	e152                	sd	s4,128(sp)
    4a84:	fcd6                	sd	s5,120(sp)
    4a86:	f8da                	sd	s6,112(sp)
    4a88:	f4de                	sd	s7,104(sp)
    4a8a:	f0e2                	sd	s8,96(sp)
    4a8c:	ece6                	sd	s9,88(sp)
    4a8e:	e8ea                	sd	s10,80(sp)
    4a90:	e4ee                	sd	s11,72(sp)
    4a92:	1900                	addi	s0,sp,176
    4a94:	f4a43c23          	sd	a0,-168(s0)
  char *names[] = { "f0", "f1", "f2", "f3" };
    4a98:	00003797          	auipc	a5,0x3
    4a9c:	32078793          	addi	a5,a5,800 # 7db8 <malloc+0x1dbe>
    4aa0:	f6f43823          	sd	a5,-144(s0)
    4aa4:	00003797          	auipc	a5,0x3
    4aa8:	31c78793          	addi	a5,a5,796 # 7dc0 <malloc+0x1dc6>
    4aac:	f6f43c23          	sd	a5,-136(s0)
    4ab0:	00003797          	auipc	a5,0x3
    4ab4:	31878793          	addi	a5,a5,792 # 7dc8 <malloc+0x1dce>
    4ab8:	f8f43023          	sd	a5,-128(s0)
    4abc:	00003797          	auipc	a5,0x3
    4ac0:	31478793          	addi	a5,a5,788 # 7dd0 <malloc+0x1dd6>
    4ac4:	f8f43423          	sd	a5,-120(s0)
  for(pi = 0; pi < NCHILD; pi++){
    4ac8:	f7040c13          	addi	s8,s0,-144
  char *names[] = { "f0", "f1", "f2", "f3" };
    4acc:	8962                	mv	s2,s8
  for(pi = 0; pi < NCHILD; pi++){
    4ace:	4481                	li	s1,0
    4ad0:	4a11                	li	s4,4
    fname = names[pi];
    4ad2:	00093983          	ld	s3,0(s2)
    unlink(fname);
    4ad6:	854e                	mv	a0,s3
    4ad8:	00001097          	auipc	ra,0x1
    4adc:	138080e7          	jalr	312(ra) # 5c10 <unlink>
    pid = fork();
    4ae0:	00001097          	auipc	ra,0x1
    4ae4:	0d8080e7          	jalr	216(ra) # 5bb8 <fork>
    if(pid < 0){
    4ae8:	04054463          	bltz	a0,4b30 <fourfiles+0xba>
    if(pid == 0){
    4aec:	c12d                	beqz	a0,4b4e <fourfiles+0xd8>
  for(pi = 0; pi < NCHILD; pi++){
    4aee:	2485                	addiw	s1,s1,1
    4af0:	0921                	addi	s2,s2,8
    4af2:	ff4490e3          	bne	s1,s4,4ad2 <fourfiles+0x5c>
    4af6:	4491                	li	s1,4
    wait(&xstatus);
    4af8:	f6c40513          	addi	a0,s0,-148
    4afc:	00001097          	auipc	ra,0x1
    4b00:	0cc080e7          	jalr	204(ra) # 5bc8 <wait>
    if(xstatus != 0)
    4b04:	f6c42b03          	lw	s6,-148(s0)
    4b08:	0c0b1e63          	bnez	s6,4be4 <fourfiles+0x16e>
  for(pi = 0; pi < NCHILD; pi++){
    4b0c:	34fd                	addiw	s1,s1,-1
    4b0e:	f4ed                	bnez	s1,4af8 <fourfiles+0x82>
    4b10:	03000b93          	li	s7,48
    while((n = read(fd, buf, sizeof(buf))) > 0){
    4b14:	00008a17          	auipc	s4,0x8
    4b18:	154a0a13          	addi	s4,s4,340 # cc68 <buf>
    4b1c:	00008a97          	auipc	s5,0x8
    4b20:	14da8a93          	addi	s5,s5,333 # cc69 <buf+0x1>
    if(total != N*SZ){
    4b24:	6d85                	lui	s11,0x1
    4b26:	770d8d93          	addi	s11,s11,1904 # 1770 <exectest+0x30>
  for(i = 0; i < NCHILD; i++){
    4b2a:	03400d13          	li	s10,52
    4b2e:	aa1d                	j	4c64 <fourfiles+0x1ee>
      printf("fork failed\n", s);
    4b30:	f5843583          	ld	a1,-168(s0)
    4b34:	00002517          	auipc	a0,0x2
    4b38:	27450513          	addi	a0,a0,628 # 6da8 <malloc+0xdae>
    4b3c:	00001097          	auipc	ra,0x1
    4b40:	406080e7          	jalr	1030(ra) # 5f42 <printf>
      exit(1);
    4b44:	4505                	li	a0,1
    4b46:	00001097          	auipc	ra,0x1
    4b4a:	07a080e7          	jalr	122(ra) # 5bc0 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    4b4e:	20200593          	li	a1,514
    4b52:	854e                	mv	a0,s3
    4b54:	00001097          	auipc	ra,0x1
    4b58:	0ac080e7          	jalr	172(ra) # 5c00 <open>
    4b5c:	892a                	mv	s2,a0
      if(fd < 0){
    4b5e:	04054763          	bltz	a0,4bac <fourfiles+0x136>
      memset(buf, '0'+pi, SZ);
    4b62:	1f400613          	li	a2,500
    4b66:	0304859b          	addiw	a1,s1,48
    4b6a:	00008517          	auipc	a0,0x8
    4b6e:	0fe50513          	addi	a0,a0,254 # cc68 <buf>
    4b72:	00001097          	auipc	ra,0x1
    4b76:	e54080e7          	jalr	-428(ra) # 59c6 <memset>
    4b7a:	44b1                	li	s1,12
        if((n = write(fd, buf, SZ)) != SZ){
    4b7c:	00008997          	auipc	s3,0x8
    4b80:	0ec98993          	addi	s3,s3,236 # cc68 <buf>
    4b84:	1f400613          	li	a2,500
    4b88:	85ce                	mv	a1,s3
    4b8a:	854a                	mv	a0,s2
    4b8c:	00001097          	auipc	ra,0x1
    4b90:	054080e7          	jalr	84(ra) # 5be0 <write>
    4b94:	85aa                	mv	a1,a0
    4b96:	1f400793          	li	a5,500
    4b9a:	02f51863          	bne	a0,a5,4bca <fourfiles+0x154>
      for(i = 0; i < N; i++){
    4b9e:	34fd                	addiw	s1,s1,-1
    4ba0:	f0f5                	bnez	s1,4b84 <fourfiles+0x10e>
      exit(0);
    4ba2:	4501                	li	a0,0
    4ba4:	00001097          	auipc	ra,0x1
    4ba8:	01c080e7          	jalr	28(ra) # 5bc0 <exit>
        printf("create failed\n", s);
    4bac:	f5843583          	ld	a1,-168(s0)
    4bb0:	00003517          	auipc	a0,0x3
    4bb4:	22850513          	addi	a0,a0,552 # 7dd8 <malloc+0x1dde>
    4bb8:	00001097          	auipc	ra,0x1
    4bbc:	38a080e7          	jalr	906(ra) # 5f42 <printf>
        exit(1);
    4bc0:	4505                	li	a0,1
    4bc2:	00001097          	auipc	ra,0x1
    4bc6:	ffe080e7          	jalr	-2(ra) # 5bc0 <exit>
          printf("write failed %d\n", n);
    4bca:	00003517          	auipc	a0,0x3
    4bce:	21e50513          	addi	a0,a0,542 # 7de8 <malloc+0x1dee>
    4bd2:	00001097          	auipc	ra,0x1
    4bd6:	370080e7          	jalr	880(ra) # 5f42 <printf>
          exit(1);
    4bda:	4505                	li	a0,1
    4bdc:	00001097          	auipc	ra,0x1
    4be0:	fe4080e7          	jalr	-28(ra) # 5bc0 <exit>
      exit(xstatus);
    4be4:	855a                	mv	a0,s6
    4be6:	00001097          	auipc	ra,0x1
    4bea:	fda080e7          	jalr	-38(ra) # 5bc0 <exit>
          printf("wrong char\n", s);
    4bee:	f5843583          	ld	a1,-168(s0)
    4bf2:	00003517          	auipc	a0,0x3
    4bf6:	20e50513          	addi	a0,a0,526 # 7e00 <malloc+0x1e06>
    4bfa:	00001097          	auipc	ra,0x1
    4bfe:	348080e7          	jalr	840(ra) # 5f42 <printf>
          exit(1);
    4c02:	4505                	li	a0,1
    4c04:	00001097          	auipc	ra,0x1
    4c08:	fbc080e7          	jalr	-68(ra) # 5bc0 <exit>
      total += n;
    4c0c:	00a9093b          	addw	s2,s2,a0
    while((n = read(fd, buf, sizeof(buf))) > 0){
    4c10:	660d                	lui	a2,0x3
    4c12:	85d2                	mv	a1,s4
    4c14:	854e                	mv	a0,s3
    4c16:	00001097          	auipc	ra,0x1
    4c1a:	fc2080e7          	jalr	-62(ra) # 5bd8 <read>
    4c1e:	02a05363          	blez	a0,4c44 <fourfiles+0x1ce>
    4c22:	00008797          	auipc	a5,0x8
    4c26:	04678793          	addi	a5,a5,70 # cc68 <buf>
    4c2a:	fff5069b          	addiw	a3,a0,-1
    4c2e:	1682                	slli	a3,a3,0x20
    4c30:	9281                	srli	a3,a3,0x20
    4c32:	96d6                	add	a3,a3,s5
        if(buf[j] != '0'+i){
    4c34:	0007c703          	lbu	a4,0(a5)
    4c38:	fa971be3          	bne	a4,s1,4bee <fourfiles+0x178>
      for(j = 0; j < n; j++){
    4c3c:	0785                	addi	a5,a5,1
    4c3e:	fed79be3          	bne	a5,a3,4c34 <fourfiles+0x1be>
    4c42:	b7e9                	j	4c0c <fourfiles+0x196>
    close(fd);
    4c44:	854e                	mv	a0,s3
    4c46:	00001097          	auipc	ra,0x1
    4c4a:	fa2080e7          	jalr	-94(ra) # 5be8 <close>
    if(total != N*SZ){
    4c4e:	03b91863          	bne	s2,s11,4c7e <fourfiles+0x208>
    unlink(fname);
    4c52:	8566                	mv	a0,s9
    4c54:	00001097          	auipc	ra,0x1
    4c58:	fbc080e7          	jalr	-68(ra) # 5c10 <unlink>
  for(i = 0; i < NCHILD; i++){
    4c5c:	0c21                	addi	s8,s8,8
    4c5e:	2b85                	addiw	s7,s7,1
    4c60:	03ab8d63          	beq	s7,s10,4c9a <fourfiles+0x224>
    fname = names[i];
    4c64:	000c3c83          	ld	s9,0(s8)
    fd = open(fname, 0);
    4c68:	4581                	li	a1,0
    4c6a:	8566                	mv	a0,s9
    4c6c:	00001097          	auipc	ra,0x1
    4c70:	f94080e7          	jalr	-108(ra) # 5c00 <open>
    4c74:	89aa                	mv	s3,a0
    total = 0;
    4c76:	895a                	mv	s2,s6
        if(buf[j] != '0'+i){
    4c78:	000b849b          	sext.w	s1,s7
    while((n = read(fd, buf, sizeof(buf))) > 0){
    4c7c:	bf51                	j	4c10 <fourfiles+0x19a>
      printf("wrong length %d\n", total);
    4c7e:	85ca                	mv	a1,s2
    4c80:	00003517          	auipc	a0,0x3
    4c84:	19050513          	addi	a0,a0,400 # 7e10 <malloc+0x1e16>
    4c88:	00001097          	auipc	ra,0x1
    4c8c:	2ba080e7          	jalr	698(ra) # 5f42 <printf>
      exit(1);
    4c90:	4505                	li	a0,1
    4c92:	00001097          	auipc	ra,0x1
    4c96:	f2e080e7          	jalr	-210(ra) # 5bc0 <exit>
}
    4c9a:	70aa                	ld	ra,168(sp)
    4c9c:	740a                	ld	s0,160(sp)
    4c9e:	64ea                	ld	s1,152(sp)
    4ca0:	694a                	ld	s2,144(sp)
    4ca2:	69aa                	ld	s3,136(sp)
    4ca4:	6a0a                	ld	s4,128(sp)
    4ca6:	7ae6                	ld	s5,120(sp)
    4ca8:	7b46                	ld	s6,112(sp)
    4caa:	7ba6                	ld	s7,104(sp)
    4cac:	7c06                	ld	s8,96(sp)
    4cae:	6ce6                	ld	s9,88(sp)
    4cb0:	6d46                	ld	s10,80(sp)
    4cb2:	6da6                	ld	s11,72(sp)
    4cb4:	614d                	addi	sp,sp,176
    4cb6:	8082                	ret

0000000000004cb8 <concreate>:
{
    4cb8:	7135                	addi	sp,sp,-160
    4cba:	ed06                	sd	ra,152(sp)
    4cbc:	e922                	sd	s0,144(sp)
    4cbe:	e526                	sd	s1,136(sp)
    4cc0:	e14a                	sd	s2,128(sp)
    4cc2:	fcce                	sd	s3,120(sp)
    4cc4:	f8d2                	sd	s4,112(sp)
    4cc6:	f4d6                	sd	s5,104(sp)
    4cc8:	f0da                	sd	s6,96(sp)
    4cca:	ecde                	sd	s7,88(sp)
    4ccc:	1100                	addi	s0,sp,160
    4cce:	89aa                	mv	s3,a0
  file[0] = 'C';
    4cd0:	04300793          	li	a5,67
    4cd4:	faf40423          	sb	a5,-88(s0)
  file[2] = '\0';
    4cd8:	fa040523          	sb	zero,-86(s0)
  for(i = 0; i < N; i++){
    4cdc:	4901                	li	s2,0
    if(pid && (i % 3) == 1){
    4cde:	4b0d                	li	s6,3
    4ce0:	4a85                	li	s5,1
      link("C0", file);
    4ce2:	00003b97          	auipc	s7,0x3
    4ce6:	146b8b93          	addi	s7,s7,326 # 7e28 <malloc+0x1e2e>
  for(i = 0; i < N; i++){
    4cea:	02800a13          	li	s4,40
    4cee:	acc9                	j	4fc0 <concreate+0x308>
      link("C0", file);
    4cf0:	fa840593          	addi	a1,s0,-88
    4cf4:	855e                	mv	a0,s7
    4cf6:	00001097          	auipc	ra,0x1
    4cfa:	f2a080e7          	jalr	-214(ra) # 5c20 <link>
    if(pid == 0) {
    4cfe:	a465                	j	4fa6 <concreate+0x2ee>
    } else if(pid == 0 && (i % 5) == 1){
    4d00:	4795                	li	a5,5
    4d02:	02f9693b          	remw	s2,s2,a5
    4d06:	4785                	li	a5,1
    4d08:	02f90b63          	beq	s2,a5,4d3e <concreate+0x86>
      fd = open(file, O_CREATE | O_RDWR);
    4d0c:	20200593          	li	a1,514
    4d10:	fa840513          	addi	a0,s0,-88
    4d14:	00001097          	auipc	ra,0x1
    4d18:	eec080e7          	jalr	-276(ra) # 5c00 <open>
      if(fd < 0){
    4d1c:	26055c63          	bgez	a0,4f94 <concreate+0x2dc>
        printf("concreate create %s failed\n", file);
    4d20:	fa840593          	addi	a1,s0,-88
    4d24:	00003517          	auipc	a0,0x3
    4d28:	10c50513          	addi	a0,a0,268 # 7e30 <malloc+0x1e36>
    4d2c:	00001097          	auipc	ra,0x1
    4d30:	216080e7          	jalr	534(ra) # 5f42 <printf>
        exit(1);
    4d34:	4505                	li	a0,1
    4d36:	00001097          	auipc	ra,0x1
    4d3a:	e8a080e7          	jalr	-374(ra) # 5bc0 <exit>
      link("C0", file);
    4d3e:	fa840593          	addi	a1,s0,-88
    4d42:	00003517          	auipc	a0,0x3
    4d46:	0e650513          	addi	a0,a0,230 # 7e28 <malloc+0x1e2e>
    4d4a:	00001097          	auipc	ra,0x1
    4d4e:	ed6080e7          	jalr	-298(ra) # 5c20 <link>
      exit(0);
    4d52:	4501                	li	a0,0
    4d54:	00001097          	auipc	ra,0x1
    4d58:	e6c080e7          	jalr	-404(ra) # 5bc0 <exit>
        exit(1);
    4d5c:	4505                	li	a0,1
    4d5e:	00001097          	auipc	ra,0x1
    4d62:	e62080e7          	jalr	-414(ra) # 5bc0 <exit>
  memset(fa, 0, sizeof(fa));
    4d66:	02800613          	li	a2,40
    4d6a:	4581                	li	a1,0
    4d6c:	f8040513          	addi	a0,s0,-128
    4d70:	00001097          	auipc	ra,0x1
    4d74:	c56080e7          	jalr	-938(ra) # 59c6 <memset>
  fd = open(".", 0);
    4d78:	4581                	li	a1,0
    4d7a:	00002517          	auipc	a0,0x2
    4d7e:	a8650513          	addi	a0,a0,-1402 # 6800 <malloc+0x806>
    4d82:	00001097          	auipc	ra,0x1
    4d86:	e7e080e7          	jalr	-386(ra) # 5c00 <open>
    4d8a:	892a                	mv	s2,a0
  n = 0;
    4d8c:	8aa6                	mv	s5,s1
    if(de.name[0] == 'C' && de.name[2] == '\0'){
    4d8e:	04300a13          	li	s4,67
      if(i < 0 || i >= sizeof(fa)){
    4d92:	02700b13          	li	s6,39
      fa[i] = 1;
    4d96:	4b85                	li	s7,1
  while(read(fd, &de, sizeof(de)) > 0){
    4d98:	4641                	li	a2,16
    4d9a:	f7040593          	addi	a1,s0,-144
    4d9e:	854a                	mv	a0,s2
    4da0:	00001097          	auipc	ra,0x1
    4da4:	e38080e7          	jalr	-456(ra) # 5bd8 <read>
    4da8:	08a05263          	blez	a0,4e2c <concreate+0x174>
    if(de.inum == 0)
    4dac:	f7045783          	lhu	a5,-144(s0)
    4db0:	d7e5                	beqz	a5,4d98 <concreate+0xe0>
    if(de.name[0] == 'C' && de.name[2] == '\0'){
    4db2:	f7244783          	lbu	a5,-142(s0)
    4db6:	ff4791e3          	bne	a5,s4,4d98 <concreate+0xe0>
    4dba:	f7444783          	lbu	a5,-140(s0)
    4dbe:	ffe9                	bnez	a5,4d98 <concreate+0xe0>
      i = de.name[1] - '0';
    4dc0:	f7344783          	lbu	a5,-141(s0)
    4dc4:	fd07879b          	addiw	a5,a5,-48
    4dc8:	0007871b          	sext.w	a4,a5
      if(i < 0 || i >= sizeof(fa)){
    4dcc:	02eb6063          	bltu	s6,a4,4dec <concreate+0x134>
      if(fa[i]){
    4dd0:	fb070793          	addi	a5,a4,-80 # fb0 <linktest+0xbc>
    4dd4:	97a2                	add	a5,a5,s0
    4dd6:	fd07c783          	lbu	a5,-48(a5)
    4dda:	eb8d                	bnez	a5,4e0c <concreate+0x154>
      fa[i] = 1;
    4ddc:	fb070793          	addi	a5,a4,-80
    4de0:	00878733          	add	a4,a5,s0
    4de4:	fd770823          	sb	s7,-48(a4)
      n++;
    4de8:	2a85                	addiw	s5,s5,1
    4dea:	b77d                	j	4d98 <concreate+0xe0>
        printf("%s: concreate weird file %s\n", s, de.name);
    4dec:	f7240613          	addi	a2,s0,-142
    4df0:	85ce                	mv	a1,s3
    4df2:	00003517          	auipc	a0,0x3
    4df6:	05e50513          	addi	a0,a0,94 # 7e50 <malloc+0x1e56>
    4dfa:	00001097          	auipc	ra,0x1
    4dfe:	148080e7          	jalr	328(ra) # 5f42 <printf>
        exit(1);
    4e02:	4505                	li	a0,1
    4e04:	00001097          	auipc	ra,0x1
    4e08:	dbc080e7          	jalr	-580(ra) # 5bc0 <exit>
        printf("%s: concreate duplicate file %s\n", s, de.name);
    4e0c:	f7240613          	addi	a2,s0,-142
    4e10:	85ce                	mv	a1,s3
    4e12:	00003517          	auipc	a0,0x3
    4e16:	05e50513          	addi	a0,a0,94 # 7e70 <malloc+0x1e76>
    4e1a:	00001097          	auipc	ra,0x1
    4e1e:	128080e7          	jalr	296(ra) # 5f42 <printf>
        exit(1);
    4e22:	4505                	li	a0,1
    4e24:	00001097          	auipc	ra,0x1
    4e28:	d9c080e7          	jalr	-612(ra) # 5bc0 <exit>
  close(fd);
    4e2c:	854a                	mv	a0,s2
    4e2e:	00001097          	auipc	ra,0x1
    4e32:	dba080e7          	jalr	-582(ra) # 5be8 <close>
  if(n != N){
    4e36:	02800793          	li	a5,40
    4e3a:	00fa9763          	bne	s5,a5,4e48 <concreate+0x190>
    if(((i % 3) == 0 && pid == 0) ||
    4e3e:	4a8d                	li	s5,3
    4e40:	4b05                	li	s6,1
  for(i = 0; i < N; i++){
    4e42:	02800a13          	li	s4,40
    4e46:	a8c9                	j	4f18 <concreate+0x260>
    printf("%s: concreate not enough files in directory listing\n", s);
    4e48:	85ce                	mv	a1,s3
    4e4a:	00003517          	auipc	a0,0x3
    4e4e:	04e50513          	addi	a0,a0,78 # 7e98 <malloc+0x1e9e>
    4e52:	00001097          	auipc	ra,0x1
    4e56:	0f0080e7          	jalr	240(ra) # 5f42 <printf>
    exit(1);
    4e5a:	4505                	li	a0,1
    4e5c:	00001097          	auipc	ra,0x1
    4e60:	d64080e7          	jalr	-668(ra) # 5bc0 <exit>
      printf("%s: fork failed\n", s);
    4e64:	85ce                	mv	a1,s3
    4e66:	00002517          	auipc	a0,0x2
    4e6a:	b3a50513          	addi	a0,a0,-1222 # 69a0 <malloc+0x9a6>
    4e6e:	00001097          	auipc	ra,0x1
    4e72:	0d4080e7          	jalr	212(ra) # 5f42 <printf>
      exit(1);
    4e76:	4505                	li	a0,1
    4e78:	00001097          	auipc	ra,0x1
    4e7c:	d48080e7          	jalr	-696(ra) # 5bc0 <exit>
      close(open(file, 0));
    4e80:	4581                	li	a1,0
    4e82:	fa840513          	addi	a0,s0,-88
    4e86:	00001097          	auipc	ra,0x1
    4e8a:	d7a080e7          	jalr	-646(ra) # 5c00 <open>
    4e8e:	00001097          	auipc	ra,0x1
    4e92:	d5a080e7          	jalr	-678(ra) # 5be8 <close>
      close(open(file, 0));
    4e96:	4581                	li	a1,0
    4e98:	fa840513          	addi	a0,s0,-88
    4e9c:	00001097          	auipc	ra,0x1
    4ea0:	d64080e7          	jalr	-668(ra) # 5c00 <open>
    4ea4:	00001097          	auipc	ra,0x1
    4ea8:	d44080e7          	jalr	-700(ra) # 5be8 <close>
      close(open(file, 0));
    4eac:	4581                	li	a1,0
    4eae:	fa840513          	addi	a0,s0,-88
    4eb2:	00001097          	auipc	ra,0x1
    4eb6:	d4e080e7          	jalr	-690(ra) # 5c00 <open>
    4eba:	00001097          	auipc	ra,0x1
    4ebe:	d2e080e7          	jalr	-722(ra) # 5be8 <close>
      close(open(file, 0));
    4ec2:	4581                	li	a1,0
    4ec4:	fa840513          	addi	a0,s0,-88
    4ec8:	00001097          	auipc	ra,0x1
    4ecc:	d38080e7          	jalr	-712(ra) # 5c00 <open>
    4ed0:	00001097          	auipc	ra,0x1
    4ed4:	d18080e7          	jalr	-744(ra) # 5be8 <close>
      close(open(file, 0));
    4ed8:	4581                	li	a1,0
    4eda:	fa840513          	addi	a0,s0,-88
    4ede:	00001097          	auipc	ra,0x1
    4ee2:	d22080e7          	jalr	-734(ra) # 5c00 <open>
    4ee6:	00001097          	auipc	ra,0x1
    4eea:	d02080e7          	jalr	-766(ra) # 5be8 <close>
      close(open(file, 0));
    4eee:	4581                	li	a1,0
    4ef0:	fa840513          	addi	a0,s0,-88
    4ef4:	00001097          	auipc	ra,0x1
    4ef8:	d0c080e7          	jalr	-756(ra) # 5c00 <open>
    4efc:	00001097          	auipc	ra,0x1
    4f00:	cec080e7          	jalr	-788(ra) # 5be8 <close>
    if(pid == 0)
    4f04:	08090363          	beqz	s2,4f8a <concreate+0x2d2>
      wait(0);
    4f08:	4501                	li	a0,0
    4f0a:	00001097          	auipc	ra,0x1
    4f0e:	cbe080e7          	jalr	-834(ra) # 5bc8 <wait>
  for(i = 0; i < N; i++){
    4f12:	2485                	addiw	s1,s1,1
    4f14:	0f448563          	beq	s1,s4,4ffe <concreate+0x346>
    file[1] = '0' + i;
    4f18:	0304879b          	addiw	a5,s1,48
    4f1c:	faf404a3          	sb	a5,-87(s0)
    pid = fork();
    4f20:	00001097          	auipc	ra,0x1
    4f24:	c98080e7          	jalr	-872(ra) # 5bb8 <fork>
    4f28:	892a                	mv	s2,a0
    if(pid < 0){
    4f2a:	f2054de3          	bltz	a0,4e64 <concreate+0x1ac>
    if(((i % 3) == 0 && pid == 0) ||
    4f2e:	0354e73b          	remw	a4,s1,s5
    4f32:	00a767b3          	or	a5,a4,a0
    4f36:	2781                	sext.w	a5,a5
    4f38:	d7a1                	beqz	a5,4e80 <concreate+0x1c8>
    4f3a:	01671363          	bne	a4,s6,4f40 <concreate+0x288>
       ((i % 3) == 1 && pid != 0)){
    4f3e:	f129                	bnez	a0,4e80 <concreate+0x1c8>
      unlink(file);
    4f40:	fa840513          	addi	a0,s0,-88
    4f44:	00001097          	auipc	ra,0x1
    4f48:	ccc080e7          	jalr	-820(ra) # 5c10 <unlink>
      unlink(file);
    4f4c:	fa840513          	addi	a0,s0,-88
    4f50:	00001097          	auipc	ra,0x1
    4f54:	cc0080e7          	jalr	-832(ra) # 5c10 <unlink>
      unlink(file);
    4f58:	fa840513          	addi	a0,s0,-88
    4f5c:	00001097          	auipc	ra,0x1
    4f60:	cb4080e7          	jalr	-844(ra) # 5c10 <unlink>
      unlink(file);
    4f64:	fa840513          	addi	a0,s0,-88
    4f68:	00001097          	auipc	ra,0x1
    4f6c:	ca8080e7          	jalr	-856(ra) # 5c10 <unlink>
      unlink(file);
    4f70:	fa840513          	addi	a0,s0,-88
    4f74:	00001097          	auipc	ra,0x1
    4f78:	c9c080e7          	jalr	-868(ra) # 5c10 <unlink>
      unlink(file);
    4f7c:	fa840513          	addi	a0,s0,-88
    4f80:	00001097          	auipc	ra,0x1
    4f84:	c90080e7          	jalr	-880(ra) # 5c10 <unlink>
    4f88:	bfb5                	j	4f04 <concreate+0x24c>
      exit(0);
    4f8a:	4501                	li	a0,0
    4f8c:	00001097          	auipc	ra,0x1
    4f90:	c34080e7          	jalr	-972(ra) # 5bc0 <exit>
      close(fd);
    4f94:	00001097          	auipc	ra,0x1
    4f98:	c54080e7          	jalr	-940(ra) # 5be8 <close>
    if(pid == 0) {
    4f9c:	bb5d                	j	4d52 <concreate+0x9a>
      close(fd);
    4f9e:	00001097          	auipc	ra,0x1
    4fa2:	c4a080e7          	jalr	-950(ra) # 5be8 <close>
      wait(&xstatus);
    4fa6:	f6c40513          	addi	a0,s0,-148
    4faa:	00001097          	auipc	ra,0x1
    4fae:	c1e080e7          	jalr	-994(ra) # 5bc8 <wait>
      if(xstatus != 0)
    4fb2:	f6c42483          	lw	s1,-148(s0)
    4fb6:	da0493e3          	bnez	s1,4d5c <concreate+0xa4>
  for(i = 0; i < N; i++){
    4fba:	2905                	addiw	s2,s2,1
    4fbc:	db4905e3          	beq	s2,s4,4d66 <concreate+0xae>
    file[1] = '0' + i;
    4fc0:	0309079b          	addiw	a5,s2,48
    4fc4:	faf404a3          	sb	a5,-87(s0)
    unlink(file);
    4fc8:	fa840513          	addi	a0,s0,-88
    4fcc:	00001097          	auipc	ra,0x1
    4fd0:	c44080e7          	jalr	-956(ra) # 5c10 <unlink>
    pid = fork();
    4fd4:	00001097          	auipc	ra,0x1
    4fd8:	be4080e7          	jalr	-1052(ra) # 5bb8 <fork>
    if(pid && (i % 3) == 1){
    4fdc:	d20502e3          	beqz	a0,4d00 <concreate+0x48>
    4fe0:	036967bb          	remw	a5,s2,s6
    4fe4:	d15786e3          	beq	a5,s5,4cf0 <concreate+0x38>
      fd = open(file, O_CREATE | O_RDWR);
    4fe8:	20200593          	li	a1,514
    4fec:	fa840513          	addi	a0,s0,-88
    4ff0:	00001097          	auipc	ra,0x1
    4ff4:	c10080e7          	jalr	-1008(ra) # 5c00 <open>
      if(fd < 0){
    4ff8:	fa0553e3          	bgez	a0,4f9e <concreate+0x2e6>
    4ffc:	b315                	j	4d20 <concreate+0x68>
}
    4ffe:	60ea                	ld	ra,152(sp)
    5000:	644a                	ld	s0,144(sp)
    5002:	64aa                	ld	s1,136(sp)
    5004:	690a                	ld	s2,128(sp)
    5006:	79e6                	ld	s3,120(sp)
    5008:	7a46                	ld	s4,112(sp)
    500a:	7aa6                	ld	s5,104(sp)
    500c:	7b06                	ld	s6,96(sp)
    500e:	6be6                	ld	s7,88(sp)
    5010:	610d                	addi	sp,sp,160
    5012:	8082                	ret

0000000000005014 <bigfile>:
{
    5014:	7139                	addi	sp,sp,-64
    5016:	fc06                	sd	ra,56(sp)
    5018:	f822                	sd	s0,48(sp)
    501a:	f426                	sd	s1,40(sp)
    501c:	f04a                	sd	s2,32(sp)
    501e:	ec4e                	sd	s3,24(sp)
    5020:	e852                	sd	s4,16(sp)
    5022:	e456                	sd	s5,8(sp)
    5024:	0080                	addi	s0,sp,64
    5026:	8aaa                	mv	s5,a0
  unlink("bigfile.dat");
    5028:	00003517          	auipc	a0,0x3
    502c:	ea850513          	addi	a0,a0,-344 # 7ed0 <malloc+0x1ed6>
    5030:	00001097          	auipc	ra,0x1
    5034:	be0080e7          	jalr	-1056(ra) # 5c10 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    5038:	20200593          	li	a1,514
    503c:	00003517          	auipc	a0,0x3
    5040:	e9450513          	addi	a0,a0,-364 # 7ed0 <malloc+0x1ed6>
    5044:	00001097          	auipc	ra,0x1
    5048:	bbc080e7          	jalr	-1092(ra) # 5c00 <open>
    504c:	89aa                	mv	s3,a0
  for(i = 0; i < N; i++){
    504e:	4481                	li	s1,0
    memset(buf, i, SZ);
    5050:	00008917          	auipc	s2,0x8
    5054:	c1890913          	addi	s2,s2,-1000 # cc68 <buf>
  for(i = 0; i < N; i++){
    5058:	4a51                	li	s4,20
  if(fd < 0){
    505a:	0a054063          	bltz	a0,50fa <bigfile+0xe6>
    memset(buf, i, SZ);
    505e:	25800613          	li	a2,600
    5062:	85a6                	mv	a1,s1
    5064:	854a                	mv	a0,s2
    5066:	00001097          	auipc	ra,0x1
    506a:	960080e7          	jalr	-1696(ra) # 59c6 <memset>
    if(write(fd, buf, SZ) != SZ){
    506e:	25800613          	li	a2,600
    5072:	85ca                	mv	a1,s2
    5074:	854e                	mv	a0,s3
    5076:	00001097          	auipc	ra,0x1
    507a:	b6a080e7          	jalr	-1174(ra) # 5be0 <write>
    507e:	25800793          	li	a5,600
    5082:	08f51a63          	bne	a0,a5,5116 <bigfile+0x102>
  for(i = 0; i < N; i++){
    5086:	2485                	addiw	s1,s1,1
    5088:	fd449be3          	bne	s1,s4,505e <bigfile+0x4a>
  close(fd);
    508c:	854e                	mv	a0,s3
    508e:	00001097          	auipc	ra,0x1
    5092:	b5a080e7          	jalr	-1190(ra) # 5be8 <close>
  fd = open("bigfile.dat", 0);
    5096:	4581                	li	a1,0
    5098:	00003517          	auipc	a0,0x3
    509c:	e3850513          	addi	a0,a0,-456 # 7ed0 <malloc+0x1ed6>
    50a0:	00001097          	auipc	ra,0x1
    50a4:	b60080e7          	jalr	-1184(ra) # 5c00 <open>
    50a8:	8a2a                	mv	s4,a0
  total = 0;
    50aa:	4981                	li	s3,0
  for(i = 0; ; i++){
    50ac:	4481                	li	s1,0
    cc = read(fd, buf, SZ/2);
    50ae:	00008917          	auipc	s2,0x8
    50b2:	bba90913          	addi	s2,s2,-1094 # cc68 <buf>
  if(fd < 0){
    50b6:	06054e63          	bltz	a0,5132 <bigfile+0x11e>
    cc = read(fd, buf, SZ/2);
    50ba:	12c00613          	li	a2,300
    50be:	85ca                	mv	a1,s2
    50c0:	8552                	mv	a0,s4
    50c2:	00001097          	auipc	ra,0x1
    50c6:	b16080e7          	jalr	-1258(ra) # 5bd8 <read>
    if(cc < 0){
    50ca:	08054263          	bltz	a0,514e <bigfile+0x13a>
    if(cc == 0)
    50ce:	c971                	beqz	a0,51a2 <bigfile+0x18e>
    if(cc != SZ/2){
    50d0:	12c00793          	li	a5,300
    50d4:	08f51b63          	bne	a0,a5,516a <bigfile+0x156>
    if(buf[0] != i/2 || buf[SZ/2-1] != i/2){
    50d8:	01f4d79b          	srliw	a5,s1,0x1f
    50dc:	9fa5                	addw	a5,a5,s1
    50de:	4017d79b          	sraiw	a5,a5,0x1
    50e2:	00094703          	lbu	a4,0(s2)
    50e6:	0af71063          	bne	a4,a5,5186 <bigfile+0x172>
    50ea:	12b94703          	lbu	a4,299(s2)
    50ee:	08f71c63          	bne	a4,a5,5186 <bigfile+0x172>
    total += cc;
    50f2:	12c9899b          	addiw	s3,s3,300
  for(i = 0; ; i++){
    50f6:	2485                	addiw	s1,s1,1
    cc = read(fd, buf, SZ/2);
    50f8:	b7c9                	j	50ba <bigfile+0xa6>
    printf("%s: cannot create bigfile", s);
    50fa:	85d6                	mv	a1,s5
    50fc:	00003517          	auipc	a0,0x3
    5100:	de450513          	addi	a0,a0,-540 # 7ee0 <malloc+0x1ee6>
    5104:	00001097          	auipc	ra,0x1
    5108:	e3e080e7          	jalr	-450(ra) # 5f42 <printf>
    exit(1);
    510c:	4505                	li	a0,1
    510e:	00001097          	auipc	ra,0x1
    5112:	ab2080e7          	jalr	-1358(ra) # 5bc0 <exit>
      printf("%s: write bigfile failed\n", s);
    5116:	85d6                	mv	a1,s5
    5118:	00003517          	auipc	a0,0x3
    511c:	de850513          	addi	a0,a0,-536 # 7f00 <malloc+0x1f06>
    5120:	00001097          	auipc	ra,0x1
    5124:	e22080e7          	jalr	-478(ra) # 5f42 <printf>
      exit(1);
    5128:	4505                	li	a0,1
    512a:	00001097          	auipc	ra,0x1
    512e:	a96080e7          	jalr	-1386(ra) # 5bc0 <exit>
    printf("%s: cannot open bigfile\n", s);
    5132:	85d6                	mv	a1,s5
    5134:	00003517          	auipc	a0,0x3
    5138:	dec50513          	addi	a0,a0,-532 # 7f20 <malloc+0x1f26>
    513c:	00001097          	auipc	ra,0x1
    5140:	e06080e7          	jalr	-506(ra) # 5f42 <printf>
    exit(1);
    5144:	4505                	li	a0,1
    5146:	00001097          	auipc	ra,0x1
    514a:	a7a080e7          	jalr	-1414(ra) # 5bc0 <exit>
      printf("%s: read bigfile failed\n", s);
    514e:	85d6                	mv	a1,s5
    5150:	00003517          	auipc	a0,0x3
    5154:	df050513          	addi	a0,a0,-528 # 7f40 <malloc+0x1f46>
    5158:	00001097          	auipc	ra,0x1
    515c:	dea080e7          	jalr	-534(ra) # 5f42 <printf>
      exit(1);
    5160:	4505                	li	a0,1
    5162:	00001097          	auipc	ra,0x1
    5166:	a5e080e7          	jalr	-1442(ra) # 5bc0 <exit>
      printf("%s: short read bigfile\n", s);
    516a:	85d6                	mv	a1,s5
    516c:	00003517          	auipc	a0,0x3
    5170:	df450513          	addi	a0,a0,-524 # 7f60 <malloc+0x1f66>
    5174:	00001097          	auipc	ra,0x1
    5178:	dce080e7          	jalr	-562(ra) # 5f42 <printf>
      exit(1);
    517c:	4505                	li	a0,1
    517e:	00001097          	auipc	ra,0x1
    5182:	a42080e7          	jalr	-1470(ra) # 5bc0 <exit>
      printf("%s: read bigfile wrong data\n", s);
    5186:	85d6                	mv	a1,s5
    5188:	00003517          	auipc	a0,0x3
    518c:	df050513          	addi	a0,a0,-528 # 7f78 <malloc+0x1f7e>
    5190:	00001097          	auipc	ra,0x1
    5194:	db2080e7          	jalr	-590(ra) # 5f42 <printf>
      exit(1);
    5198:	4505                	li	a0,1
    519a:	00001097          	auipc	ra,0x1
    519e:	a26080e7          	jalr	-1498(ra) # 5bc0 <exit>
  close(fd);
    51a2:	8552                	mv	a0,s4
    51a4:	00001097          	auipc	ra,0x1
    51a8:	a44080e7          	jalr	-1468(ra) # 5be8 <close>
  if(total != N*SZ){
    51ac:	678d                	lui	a5,0x3
    51ae:	ee078793          	addi	a5,a5,-288 # 2ee0 <sbrklast+0x8e>
    51b2:	02f99363          	bne	s3,a5,51d8 <bigfile+0x1c4>
  unlink("bigfile.dat");
    51b6:	00003517          	auipc	a0,0x3
    51ba:	d1a50513          	addi	a0,a0,-742 # 7ed0 <malloc+0x1ed6>
    51be:	00001097          	auipc	ra,0x1
    51c2:	a52080e7          	jalr	-1454(ra) # 5c10 <unlink>
}
    ...
    51d4:	6121                	addi	sp,sp,64
    51d6:	8082                	ret
    printf("%s: read bigfile wrong total\n", s);
    51d8:	85d6                	mv	a1,s5
    51da:	00003517          	auipc	a0,0x3
    51de:	dbe50513          	addi	a0,a0,-578 # 7f98 <malloc+0x1f9e>
    51e2:	00001097          	auipc	ra,0x1
    51e6:	d60080e7          	jalr	-672(ra) # 5f42 <printf>
    exit(1);
    51ea:	4505                	li	a0,1
    51ec:	00001097          	auipc	ra,0x1
    51f0:	9d4080e7          	jalr	-1580(ra) # 5bc0 <exit>

00000000000051f4 <preempt>:
{
    51f4:	7139                	addi	sp,sp,-64
    51f6:	fc06                	sd	ra,56(sp)
    51f8:	f822                	sd	s0,48(sp)
    51fa:	f426                	sd	s1,40(sp)
    51fc:	f04a                	sd	s2,32(sp)
    51fe:	ec4e                	sd	s3,24(sp)
    5200:	e852                	sd	s4,16(sp)
    5202:	0080                	addi	s0,sp,64
    5204:	892a                	mv	s2,a0
  pid1 = fork();
    5206:	00001097          	auipc	ra,0x1
    520a:	9b2080e7          	jalr	-1614(ra) # 5bb8 <fork>
  if(pid1 < 0) {
    520e:	00054563          	bltz	a0,5218 <preempt+0x24>
    5212:	84aa                	mv	s1,a0
  if(pid1 == 0)
    5214:	e105                	bnez	a0,5234 <preempt+0x40>
    for(;;)
    5216:	a001                	j	5216 <preempt+0x22>
    printf("%s: fork failed", s);
    5218:	85ca                	mv	a1,s2
    521a:	00002517          	auipc	a0,0x2
    521e:	94650513          	addi	a0,a0,-1722 # 6b60 <malloc+0xb66>
    5222:	00001097          	auipc	ra,0x1
    5226:	d20080e7          	jalr	-736(ra) # 5f42 <printf>
    exit(1);
    522a:	4505                	li	a0,1
    522c:	00001097          	auipc	ra,0x1
    5230:	994080e7          	jalr	-1644(ra) # 5bc0 <exit>
  pid2 = fork();
    5234:	00001097          	auipc	ra,0x1
    5238:	984080e7          	jalr	-1660(ra) # 5bb8 <fork>
    523c:	89aa                	mv	s3,a0
  if(pid2 < 0) {
    523e:	00054463          	bltz	a0,5246 <preempt+0x52>
  if(pid2 == 0)
    5242:	e105                	bnez	a0,5262 <preempt+0x6e>
    for(;;)
    5244:	a001                	j	5244 <preempt+0x50>
    printf("%s: fork failed\n", s);
    5246:	85ca                	mv	a1,s2
    5248:	00001517          	auipc	a0,0x1
    524c:	75850513          	addi	a0,a0,1880 # 69a0 <malloc+0x9a6>
    5250:	00001097          	auipc	ra,0x1
    5254:	cf2080e7          	jalr	-782(ra) # 5f42 <printf>
    exit(1);
    5258:	4505                	li	a0,1
    525a:	00001097          	auipc	ra,0x1
    525e:	966080e7          	jalr	-1690(ra) # 5bc0 <exit>
  pipe(pfds);
    5262:	fc840513          	addi	a0,s0,-56
    5266:	00001097          	auipc	ra,0x1
    526a:	96a080e7          	jalr	-1686(ra) # 5bd0 <pipe>
  pid3 = fork();
    526e:	00001097          	auipc	ra,0x1
    5272:	94a080e7          	jalr	-1718(ra) # 5bb8 <fork>
    5276:	8a2a                	mv	s4,a0
  if(pid3 < 0) {
    5278:	02054e63          	bltz	a0,52b4 <preempt+0xc0>
  if(pid3 == 0){
    527c:	e525                	bnez	a0,52e4 <preempt+0xf0>
    close(pfds[0]);
    527e:	fc842503          	lw	a0,-56(s0)
    5282:	00001097          	auipc	ra,0x1
    5286:	966080e7          	jalr	-1690(ra) # 5be8 <close>
    if(write(pfds[1], "x", 1) != 1)
    528a:	4605                	li	a2,1
    528c:	00001597          	auipc	a1,0x1
    5290:	efc58593          	addi	a1,a1,-260 # 6188 <malloc+0x18e>
    5294:	fcc42503          	lw	a0,-52(s0)
    5298:	00001097          	auipc	ra,0x1
    529c:	948080e7          	jalr	-1720(ra) # 5be0 <write>
    52a0:	4785                	li	a5,1
    52a2:	02f51763          	bne	a0,a5,52d0 <preempt+0xdc>
    close(pfds[1]);
    52a6:	fcc42503          	lw	a0,-52(s0)
    52aa:	00001097          	auipc	ra,0x1
    52ae:	93e080e7          	jalr	-1730(ra) # 5be8 <close>
    for(;;)
    52b2:	a001                	j	52b2 <preempt+0xbe>
     printf("%s: fork failed\n", s);
    52b4:	85ca                	mv	a1,s2
    52b6:	00001517          	auipc	a0,0x1
    52ba:	6ea50513          	addi	a0,a0,1770 # 69a0 <malloc+0x9a6>
    52be:	00001097          	auipc	ra,0x1
    52c2:	c84080e7          	jalr	-892(ra) # 5f42 <printf>
     exit(1);
    52c6:	4505                	li	a0,1
    52c8:	00001097          	auipc	ra,0x1
    52cc:	8f8080e7          	jalr	-1800(ra) # 5bc0 <exit>
      printf("%s: preempt write error", s);
    52d0:	85ca                	mv	a1,s2
    52d2:	00003517          	auipc	a0,0x3
    52d6:	ce650513          	addi	a0,a0,-794 # 7fb8 <malloc+0x1fbe>
    52da:	00001097          	auipc	ra,0x1
    52de:	c68080e7          	jalr	-920(ra) # 5f42 <printf>
    52e2:	b7d1                	j	52a6 <preempt+0xb2>
  close(pfds[1]);
    52e4:	fcc42503          	lw	a0,-52(s0)
    52e8:	00001097          	auipc	ra,0x1
    52ec:	900080e7          	jalr	-1792(ra) # 5be8 <close>
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    52f0:	660d                	lui	a2,0x3
    52f2:	00008597          	auipc	a1,0x8
    52f6:	97658593          	addi	a1,a1,-1674 # cc68 <buf>
    52fa:	fc842503          	lw	a0,-56(s0)
    52fe:	00001097          	auipc	ra,0x1
    5302:	8da080e7          	jalr	-1830(ra) # 5bd8 <read>
    5306:	4785                	li	a5,1
    5308:	02f50363          	beq	a0,a5,532e <preempt+0x13a>
    printf("%s: preempt read error", s);
    530c:	85ca                	mv	a1,s2
    530e:	00003517          	auipc	a0,0x3
    5312:	cc250513          	addi	a0,a0,-830 # 7fd0 <malloc+0x1fd6>
    5316:	00001097          	auipc	ra,0x1
    531a:	c2c080e7          	jalr	-980(ra) # 5f42 <printf>
}
    531e:	70e2                	ld	ra,56(sp)
    5320:	7442                	ld	s0,48(sp)
    5322:	74a2                	ld	s1,40(sp)
    5324:	7902                	ld	s2,32(sp)
    5326:	69e2                	ld	s3,24(sp)
    5328:	6a42                	ld	s4,16(sp)
    532a:	6121                	addi	sp,sp,64
    532c:	8082                	ret
  close(pfds[0]);
    532e:	fc842503          	lw	a0,-56(s0)
    5332:	00001097          	auipc	ra,0x1
    5336:	8b6080e7          	jalr	-1866(ra) # 5be8 <close>
  printf("kill... ");
    533a:	00003517          	auipc	a0,0x3
    533e:	cae50513          	addi	a0,a0,-850 # 7fe8 <malloc+0x1fee>
    5342:	00001097          	auipc	ra,0x1
    5346:	c00080e7          	jalr	-1024(ra) # 5f42 <printf>
  kill(pid1);
    534a:	8526                	mv	a0,s1
    534c:	00001097          	auipc	ra,0x1
    5350:	8a4080e7          	jalr	-1884(ra) # 5bf0 <kill>
  kill(pid2);
    5354:	854e                	mv	a0,s3
    5356:	00001097          	auipc	ra,0x1
    535a:	89a080e7          	jalr	-1894(ra) # 5bf0 <kill>
  kill(pid3);
    535e:	8552                	mv	a0,s4
    5360:	00001097          	auipc	ra,0x1
    5364:	890080e7          	jalr	-1904(ra) # 5bf0 <kill>
  printf("wait... ");
    5368:	00003517          	auipc	a0,0x3
    536c:	c9050513          	addi	a0,a0,-880 # 7ff8 <malloc+0x1ffe>
    5370:	00001097          	auipc	ra,0x1
    5374:	bd2080e7          	jalr	-1070(ra) # 5f42 <printf>
  wait(0);
    5378:	4501                	li	a0,0
    537a:	00001097          	auipc	ra,0x1
    537e:	84e080e7          	jalr	-1970(ra) # 5bc8 <wait>
  wait(0);
    5382:	4501                	li	a0,0
    5384:	00001097          	auipc	ra,0x1
    5388:	844080e7          	jalr	-1980(ra) # 5bc8 <wait>
  wait(0);
    538c:	4501                	li	a0,0
    538e:	00001097          	auipc	ra,0x1
    5392:	83a080e7          	jalr	-1990(ra) # 5bc8 <wait>
    5396:	b761                	j	531e <preempt+0x12a>
...
0000000000005398 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53ba:	c5250513          	addi	a0,a0,-942 # 8008 <malloc+0x200e>
    53be:	00001097          	auipc	ra,0x1
    53c2:	b84080e7          	jalr	-1148(ra) # 5f42 <printf>
  for(nfiles = 0; ; nfiles++){
    53c6:	4481                	li	s1,0
    name[0] = 'f';
    ...
    53da:	c42c8c93          	addi	s9,s9,-958 # 8018 <malloc+0x201e>
    int total = 0;
    53de:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    53e0:	00008a17          	auipc	s4,0x8
    53e4:	888a0a13          	addi	s4,s4,-1912 # cc68 <buf>
    name[0] = 'f';
    ...
    5432:	b14080e7          	jalr	-1260(ra) # 5f42 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    5454:	bd850513          	addi	a0,a0,-1064 # 8028 <malloc+0x202e>
    5458:	00001097          	auipc	ra,0x1
    545c:	aea080e7          	jalr	-1302(ra) # 5f42 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    54ca:	b8250513          	addi	a0,a0,-1150 # 8048 <malloc+0x204e>
    54ce:	00001097          	auipc	ra,0x1
    54d2:	a74080e7          	jalr	-1420(ra) # 5f42 <printf>
}
    ...
    551a:	b2250513          	addi	a0,a0,-1246 # 8038 <malloc+0x203e>
    551e:	00001097          	auipc	ra,0x1
    5522:	a24080e7          	jalr	-1500(ra) # 5f42 <printf>
    close(fd);
    5526:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    554c:	b1850513          	addi	a0,a0,-1256 # 8060 <malloc+0x2066>
    5550:	00001097          	auipc	ra,0x1
    5554:	9f2080e7          	jalr	-1550(ra) # 5f42 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    557c:	b1050513          	addi	a0,a0,-1264 # 8088 <malloc+0x208e>
    5580:	00001097          	auipc	ra,0x1
    5584:	9c2080e7          	jalr	-1598(ra) # 5f42 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    55a0:	ad450513          	addi	a0,a0,-1324 # 8070 <malloc+0x2076>
    55a4:	00001097          	auipc	ra,0x1
    55a8:	99e080e7          	jalr	-1634(ra) # 5f42 <printf>
    exit(1);
    55ac:	4505                	li	a0,1
    ...
    55c8:	acc50513          	addi	a0,a0,-1332 # 8090 <malloc+0x2096>
    55cc:	00001097          	auipc	ra,0x1
    55d0:	976080e7          	jalr	-1674(ra) # 5f42 <printf>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    5618:	a8450513          	addi	a0,a0,-1404 # 8098 <malloc+0x209e>
    561c:	00001097          	auipc	ra,0x1
    5620:	926080e7          	jalr	-1754(ra) # 5f42 <printf>
        return 1;
    5624:	4505                	li	a0,1
}
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5672:	b1a98993          	addi	s3,s3,-1254 # 6188 <malloc+0x18e>
      uint64 a = (uint64) sbrk(4096);
    ...
    56a4:	a5050513          	addi	a0,a0,-1456 # 80f0 <malloc+0x20f6>
    56a8:	00001097          	auipc	ra,0x1
    56ac:	89a080e7          	jalr	-1894(ra) # 5f42 <printf>
        exit(1);
    56b0:	4505                	li	a0,1
    ...
    56be:	9f650513          	addi	a0,a0,-1546 # 80b0 <malloc+0x20b6>
    56c2:	00001097          	auipc	ra,0x1
    56c6:	880080e7          	jalr	-1920(ra) # 5f42 <printf>
    exit(1);
    56ca:	4505                	li	a0,1
    ...
    56d8:	9fc50513          	addi	a0,a0,-1540 # 80d0 <malloc+0x20d6>
    56dc:	00001097          	auipc	ra,0x1
    56e0:	866080e7          	jalr	-1946(ra) # 5f42 <printf>
    exit(1);
    56e4:	4505                	li	a0,1
  ...
  while(1){
    ...
    5726:	9ee50513          	addi	a0,a0,-1554 # 8110 <malloc+0x2116>
    572a:	00001097          	auipc	ra,0x1
    572e:	818080e7          	jalr	-2024(ra) # 5f42 <printf>
      exit(1);
    5732:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    5788:	9acb8b93          	addi	s7,s7,-1620 # 8130 <malloc+0x2136>
    int free0 = countfree();
    int free1 = 0;
    ...
    57d2:	774080e7          	jalr	1908(ra) # 5f42 <printf>
    int free0 = countfree();
    ...
    5822:	724080e7          	jalr	1828(ra) # 5f42 <printf>
      if(continuous != 2) {
    ...
    5832:	714080e7          	jalr	1812(ra) # 5f42 <printf>
      if(continuous != 2) {
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    589e:	8fe58593          	addi	a1,a1,-1794 # 8198 <malloc+0x219e>
    ...
    58b6:	93e58593          	addi	a1,a1,-1730 # 81f0 <malloc+0x21f6>
    ...
    58cc:	92058593          	addi	a1,a1,-1760 # 81e8 <malloc+0x21ee>
  ...
  int continuous = 0;
    ...
    58f8:	8ac50513          	addi	a0,a0,-1876 # 81a0 <malloc+0x21a6>
    58fc:	00000097          	auipc	ra,0x0
    5900:	646080e7          	jalr	1606(ra) # 5f42 <printf>
    exit(1);
    5904:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5924:	8b050513          	addi	a0,a0,-1872 # 81d0 <malloc+0x21d6>
    5928:	00000097          	auipc	ra,0x0
    592c:	61a080e7          	jalr	1562(ra) # 5f42 <printf>
  exit(0);
    5930:	4501                	li	a0,0
...
putc(int fd, char c)
{
    5c68:	1101                	addi	sp,sp,-32
    5c6a:	ec06                	sd	ra,24(sp)
    5c6c:	e822                	sd	s0,16(sp)
    5c6e:	1000                	addi	s0,sp,32
    5c70:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5c74:	4605                	li	a2,1
    5c76:	fef40593          	addi	a1,s0,-17
    5c7a:	00000097          	auipc	ra,0x0
    5c7e:	f66080e7          	jalr	-154(ra) # 5be0 <write>
}
    5c82:	60e2                	ld	ra,24(sp)
    5c84:	6442                	ld	s0,16(sp)
    5c86:	6105                	addi	sp,sp,32
    5c88:	8082                	ret

0000000000005c8a <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    5c8a:	7139                	addi	sp,sp,-64
    5c8c:	fc06                	sd	ra,56(sp)
    5c8e:	f822                	sd	s0,48(sp)
    5c90:	f426                	sd	s1,40(sp)
    5c92:	f04a                	sd	s2,32(sp)
    5c94:	ec4e                	sd	s3,24(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
    5c9a:	c299                	beqz	a3,5ca0 <printint+0x16>
    5c9c:	0805c963          	bltz	a1,5d2e <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    5ca0:	2581                	sext.w	a1,a1
  neg = 0;
    5ca2:	4881                	li	a7,0
    5ca4:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    5caa:	2601                	sext.w	a2,a2
    5cac:	00003517          	auipc	a0,0x3
    5cb0:	90450513          	addi	a0,a0,-1788 # 85b0 <digits>
    5cb4:	883a                	mv	a6,a4
    5cb6:	2705                	addiw	a4,a4,1
    5cb8:	02c5f7bb          	remuw	a5,a1,a2
    5cbc:	1782                	slli	a5,a5,0x20
    5cbe:	9381                	srli	a5,a5,0x20
    5cc0:	97aa                	add	a5,a5,a0
    5cc2:	0007c783          	lbu	a5,0(a5)
    5cc6:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5cca:	0005879b          	sext.w	a5,a1
    5cce:	02c5d5bb          	divuw	a1,a1,a2
    5cd2:	0685                	addi	a3,a3,1
    5cd4:	fec7f0e3          	bgeu	a5,a2,5cb4 <printint+0x2a>
  if(neg)
    5cd8:	00088c63          	beqz	a7,5cf0 <printint+0x66>
    buf[i++] = '-';
    5cdc:	fd070793          	addi	a5,a4,-48
    5ce0:	00878733          	add	a4,a5,s0
    5ce4:	02d00793          	li	a5,45
    5ce8:	fef70823          	sb	a5,-16(a4)
    5cec:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    5cf0:	02e05863          	blez	a4,5d20 <printint+0x96>
    5cf4:	fc040793          	addi	a5,s0,-64
    5cf8:	00e78933          	add	s2,a5,a4
    5cfc:	fff78993          	addi	s3,a5,-1
    5d00:	99ba                	add	s3,s3,a4
    5d02:	377d                	addiw	a4,a4,-1
    5d04:	1702                	slli	a4,a4,0x20
    5d06:	9301                	srli	a4,a4,0x20
    5d08:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    5d0c:	fff94583          	lbu	a1,-1(s2)
    5d10:	8526                	mv	a0,s1
    5d12:	00000097          	auipc	ra,0x0
    5d16:	f56080e7          	jalr	-170(ra) # 5c68 <putc>
  while(--i >= 0)
    5d1a:	197d                	addi	s2,s2,-1
    5d1c:	ff3918e3          	bne	s2,s3,5d0c <printint+0x82>
}
    5d20:	70e2                	ld	ra,56(sp)
    5d22:	7442                	ld	s0,48(sp)
    5d24:	74a2                	ld	s1,40(sp)
    5d26:	7902                	ld	s2,32(sp)
    5d28:	69e2                	ld	s3,24(sp)
    5d2a:	6121                	addi	sp,sp,64
    5d2c:	8082                	ret
    x = -xx;
    5d2e:	40b005bb          	negw	a1,a1
    neg = 1;
    5d32:	4885                	li	a7,1
    x = -xx;
    5d34:	bf85                	j	5ca4 <printint+0x1a>

0000000000005d36 <vprintf>:
}
...
{
    5d36:	7119                	addi	sp,sp,-128
    5d38:	fc86                	sd	ra,120(sp)
    5d3a:	f8a2                	sd	s0,112(sp)
    5d3c:	f4a6                	sd	s1,104(sp)
    5d3e:	f0ca                	sd	s2,96(sp)
    5d40:	ecce                	sd	s3,88(sp)
    5d42:	e8d2                	sd	s4,80(sp)
    5d44:	e4d6                	sd	s5,72(sp)
    5d46:	e0da                	sd	s6,64(sp)
    5d48:	fc5e                	sd	s7,56(sp)
    5d4a:	f862                	sd	s8,48(sp)
    5d4c:	f466                	sd	s9,40(sp)
    5d4e:	f06a                	sd	s10,32(sp)
    5d50:	ec6e                	sd	s11,24(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
    5d54:	0005c903          	lbu	s2,0(a1)
    5d58:	18090f63          	beqz	s2,5ef6 <vprintf+0x1c0>
    5d5c:	8aaa                	mv	s5,a0
    5d5e:	8b32                	mv	s6,a2
    5d60:	00158493          	addi	s1,a1,1
  state = 0;
    5d64:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5d66:	02500a13          	li	s4,37
    5d6a:	4c55                	li	s8,21
    5d6c:	00002c97          	auipc	s9,0x2
    5d70:	7ecc8c93          	addi	s9,s9,2028 # 8558 <malloc+0x255e>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    5d74:	02800d93          	li	s11,40
  putc(fd, 'x');
    5d78:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5d7a:	00003b97          	auipc	s7,0x3
    5d7e:	836b8b93          	addi	s7,s7,-1994 # 85b0 <digits>
    5d82:	a839                	j	5da0 <vprintf+0x6a>
        putc(fd, c);
    5d84:	85ca                	mv	a1,s2
    5d86:	8556                	mv	a0,s5
    5d88:	00000097          	auipc	ra,0x0
    5d8c:	ee0080e7          	jalr	-288(ra) # 5c68 <putc>
    5d90:	a019                	j	5d96 <vprintf+0x60>
    } else if(state == '%'){
    5d92:	01498d63          	beq	s3,s4,5dac <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
    5d96:	0485                	addi	s1,s1,1
    5d98:	fff4c903          	lbu	s2,-1(s1)
    5d9c:	14090d63          	beqz	s2,5ef6 <vprintf+0x1c0>
    if(state == 0){
    5da0:	fe0999e3          	bnez	s3,5d92 <vprintf+0x5c>
      if(c == '%'){
    5da4:	ff4910e3          	bne	s2,s4,5d84 <vprintf+0x4e>
        state = '%';
    5da8:	89d2                	mv	s3,s4
    5daa:	b7f5                	j	5d96 <vprintf+0x60>
      if(c == 'd'){
    5dac:	11490c63          	beq	s2,s4,5ec4 <vprintf+0x18e>
    5db0:	f9d9079b          	addiw	a5,s2,-99
    5db4:	0ff7f793          	zext.b	a5,a5
    5db8:	10fc6e63          	bltu	s8,a5,5ed4 <vprintf+0x19e>
    5dbc:	f9d9079b          	addiw	a5,s2,-99
    5dc0:	0ff7f713          	zext.b	a4,a5
    5dc4:	10ec6863          	bltu	s8,a4,5ed4 <vprintf+0x19e>
    5dc8:	00271793          	slli	a5,a4,0x2
    5dcc:	97e6                	add	a5,a5,s9
    5dce:	439c                	lw	a5,0(a5)
    5dd0:	97e6                	add	a5,a5,s9
    5dd2:	8782                	jr	a5
        printint(fd, va_arg(ap, int), 10, 1);
    5dd4:	008b0913          	addi	s2,s6,8
    5dd8:	4685                	li	a3,1
    5dda:	4629                	li	a2,10
    5ddc:	000b2583          	lw	a1,0(s6)
    5de0:	8556                	mv	a0,s5
    5de2:	00000097          	auipc	ra,0x0
    5de6:	ea8080e7          	jalr	-344(ra) # 5c8a <printint>
    5dea:	8b4a                	mv	s6,s2
      } else {
      ...
      state = 0;
    5dec:	4981                	li	s3,0
    5dee:	b765                	j	5d96 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    5df0:	008b0913          	addi	s2,s6,8
    5df4:	4681                	li	a3,0
    5df6:	4629                	li	a2,10
    5df8:	000b2583          	lw	a1,0(s6)
    5dfc:	8556                	mv	a0,s5
    5dfe:	00000097          	auipc	ra,0x0
    5e02:	e8c080e7          	jalr	-372(ra) # 5c8a <printint>
    5e06:	8b4a                	mv	s6,s2
      state = 0;
    5e08:	4981                	li	s3,0
    5e0a:	b771                	j	5d96 <vprintf+0x60>
    ...
    5e1e:	e70080e7          	jalr	-400(ra) # 5c8a <printint>
    5e22:	8b4a                	mv	s6,s2
      state = 0;
    5e24:	4981                	li	s3,0
    5e26:	bf85                	j	5d96 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5e28:	008b0793          	addi	a5,s6,8
    5e2c:	f8f43423          	sd	a5,-120(s0)
    5e30:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5e34:	03000593          	li	a1,48
    5e38:	8556                	mv	a0,s5
    5e3a:	00000097          	auipc	ra,0x0
    5e3e:	e2e080e7          	jalr	-466(ra) # 5c68 <putc>
  putc(fd, 'x');
    5e42:	07800593          	li	a1,120
    5e46:	8556                	mv	a0,s5
    5e48:	00000097          	auipc	ra,0x0
    5e4c:	e20080e7          	jalr	-480(ra) # 5c68 <putc>
    5e50:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5e52:	03c9d793          	srli	a5,s3,0x3c
    5e56:	97de                	add	a5,a5,s7
    5e58:	0007c583          	lbu	a1,0(a5)
    5e5c:	8556                	mv	a0,s5
    5e5e:	00000097          	auipc	ra,0x0
    5e62:	e0a080e7          	jalr	-502(ra) # 5c68 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5e66:	0992                	slli	s3,s3,0x4
    5e68:	397d                	addiw	s2,s2,-1
    5e6a:	fe0914e3          	bnez	s2,5e52 <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
    5e6e:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5e72:	4981                	li	s3,0
    5e74:	b70d                	j	5d96 <vprintf+0x60>
        s = va_arg(ap, char*);
    5e76:	008b0913          	addi	s2,s6,8
    5e7a:	000b3983          	ld	s3,0(s6)
        if(s == 0)
    5e7e:	02098163          	beqz	s3,5ea0 <vprintf+0x16a>
        while(*s != 0){
    5e82:	0009c583          	lbu	a1,0(s3)
    5e86:	c5ad                	beqz	a1,5ef0 <vprintf+0x1ba>
          putc(fd, *s);
    5e88:	8556                	mv	a0,s5
    5e8a:	00000097          	auipc	ra,0x0
    5e8e:	dde080e7          	jalr	-546(ra) # 5c68 <putc>
          s++;
    5e92:	0985                	addi	s3,s3,1
        while(*s != 0){
    5e94:	0009c583          	lbu	a1,0(s3)
    5e98:	f9e5                	bnez	a1,5e88 <vprintf+0x152>
        s = va_arg(ap, char*);
    5e9a:	8b4a                	mv	s6,s2
      state = 0;
    5e9c:	4981                	li	s3,0
    5e9e:	bde5                	j	5d96 <vprintf+0x60>
          s = "(null)";
    5ea0:	00002997          	auipc	s3,0x2
    5ea4:	6b098993          	addi	s3,s3,1712 # 8550 <malloc+0x2556>
        while(*s != 0){
    5ea8:	85ee                	mv	a1,s11
    5eaa:	bff9                	j	5e88 <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
    5eac:	008b0913          	addi	s2,s6,8
    5eb0:	000b4583          	lbu	a1,0(s6)
    5eb4:	8556                	mv	a0,s5
    5eb6:	00000097          	auipc	ra,0x0
    5eba:	db2080e7          	jalr	-590(ra) # 5c68 <putc>
    5ebe:	8b4a                	mv	s6,s2
      state = 0;
    5ec0:	4981                	li	s3,0
    5ec2:	bdd1                	j	5d96 <vprintf+0x60>
        putc(fd, c);
    5ec4:	85d2                	mv	a1,s4
    5ec6:	8556                	mv	a0,s5
    5ec8:	00000097          	auipc	ra,0x0
    5ecc:	da0080e7          	jalr	-608(ra) # 5c68 <putc>
      state = 0;
    5ed0:	4981                	li	s3,0
    5ed2:	b5d1                	j	5d96 <vprintf+0x60>
        putc(fd, '%');
    5ed4:	85d2                	mv	a1,s4
    5ed6:	8556                	mv	a0,s5
    5ed8:	00000097          	auipc	ra,0x0
    5edc:	d90080e7          	jalr	-624(ra) # 5c68 <putc>
        putc(fd, c);
    5ee0:	85ca                	mv	a1,s2
    5ee2:	8556                	mv	a0,s5
    5ee4:	00000097          	auipc	ra,0x0
    5ee8:	d84080e7          	jalr	-636(ra) # 5c68 <putc>
      state = 0;
    5eec:	4981                	li	s3,0
    5eee:	b565                	j	5d96 <vprintf+0x60>
        s = va_arg(ap, char*);
    5ef0:	8b4a                	mv	s6,s2
      state = 0;
    5ef2:	4981                	li	s3,0
    5ef4:	b54d                	j	5d96 <vprintf+0x60>
    }
  }
}
    5ef6:	70e6                	ld	ra,120(sp)
    5ef8:	7446                	ld	s0,112(sp)
    5efa:	74a6                	ld	s1,104(sp)
    5efc:	7906                	ld	s2,96(sp)
    5efe:	69e6                	ld	s3,88(sp)
    5f00:	6a46                	ld	s4,80(sp)
    5f02:	6aa6                	ld	s5,72(sp)
    5f04:	6b06                	ld	s6,64(sp)
    5f06:	7be2                	ld	s7,56(sp)
    5f08:	7c42                	ld	s8,48(sp)
    5f0a:	7ca2                	ld	s9,40(sp)
    5f0c:	7d02                	ld	s10,32(sp)
    5f0e:	6de2                	ld	s11,24(sp)
    5f10:	6109                	addi	sp,sp,128
    5f12:	8082                	ret

0000000000005f14 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5f14:	715d                	addi	sp,sp,-80
    5f16:	ec06                	sd	ra,24(sp)
    5f18:	e822                	sd	s0,16(sp)
    5f1a:	1000                	addi	s0,sp,32
    5f1c:	e010                	sd	a2,0(s0)
    5f1e:	e414                	sd	a3,8(s0)
    5f20:	e818                	sd	a4,16(s0)
    5f22:	ec1c                	sd	a5,24(s0)
    5f24:	03043023          	sd	a6,32(s0)
    5f28:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5f2c:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5f30:	8622                	mv	a2,s0
    5f32:	00000097          	auipc	ra,0x0
    5f36:	e04080e7          	jalr	-508(ra) # 5d36 <vprintf>
}
    5f3a:	60e2                	ld	ra,24(sp)
    5f3c:	6442                	ld	s0,16(sp)
    5f3e:	6161                	addi	sp,sp,80
    5f40:	8082                	ret

0000000000005f42 <printf>:

void
printf(const char *fmt, ...)
{
    5f42:	711d                	addi	sp,sp,-96
    5f44:	ec06                	sd	ra,24(sp)
    5f46:	e822                	sd	s0,16(sp)
    5f48:	1000                	addi	s0,sp,32
    5f4a:	e40c                	sd	a1,8(s0)
    5f4c:	e810                	sd	a2,16(s0)
    5f4e:	ec14                	sd	a3,24(s0)
    5f50:	f018                	sd	a4,32(s0)
    5f52:	f41c                	sd	a5,40(s0)
    5f54:	03043823          	sd	a6,48(s0)
    5f58:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5f5c:	00840613          	addi	a2,s0,8
    5f60:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5f64:	85aa                	mv	a1,a0
    5f66:	4505                	li	a0,1
    5f68:	00000097          	auipc	ra,0x0
    5f6c:	dce080e7          	jalr	-562(ra) # 5d36 <vprintf>
}
    5f70:	60e2                	ld	ra,24(sp)
    5f72:	6442                	ld	s0,16(sp)
    5f74:	6125                	addi	sp,sp,96
    5f76:	8082                	ret

0000000000005f78 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5f78:	1141                	addi	sp,sp,-16
    5f7a:	e422                	sd	s0,8(sp)
    5f7c:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5f7e:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5f82:	00003797          	auipc	a5,0x3
    5f86:	4be7b783          	ld	a5,1214(a5) # 9440 <freep>
    5f8a:	a02d                	j	5fb4 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5f8c:	4618                	lw	a4,8(a2)
    5f8e:	9f2d                	addw	a4,a4,a1
    5f90:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5f94:	6398                	ld	a4,0(a5)
    5f96:	6310                	ld	a2,0(a4)
    5f98:	a83d                	j	5fd6 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5f9a:	ff852703          	lw	a4,-8(a0)
    5f9e:	9f31                	addw	a4,a4,a2
    5fa0:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5fa2:	ff053683          	ld	a3,-16(a0)
    5fa6:	a091                	j	5fea <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5fa8:	6398                	ld	a4,0(a5)
    5faa:	00e7e463          	bltu	a5,a4,5fb2 <free+0x3a>
    5fae:	00e6ea63          	bltu	a3,a4,5fc2 <free+0x4a>
{
    5fb2:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5fb4:	fed7fae3          	bgeu	a5,a3,5fa8 <free+0x30>
    5fb8:	6398                	ld	a4,0(a5)
    5fba:	00e6e463          	bltu	a3,a4,5fc2 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5fbe:	fee7eae3          	bltu	a5,a4,5fb2 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5fc2:	ff852583          	lw	a1,-8(a0)
    5fc6:	6390                	ld	a2,0(a5)
    5fc8:	02059813          	slli	a6,a1,0x20
    5fcc:	01c85713          	srli	a4,a6,0x1c
    5fd0:	9736                	add	a4,a4,a3
    5fd2:	fae60de3          	beq	a2,a4,5f8c <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    5fd6:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5fda:	4790                	lw	a2,8(a5)
    5fdc:	02061593          	slli	a1,a2,0x20
    5fe0:	01c5d713          	srli	a4,a1,0x1c
    5fe4:	973e                	add	a4,a4,a5
    5fe6:	fae68ae3          	beq	a3,a4,5f9a <free+0x22>
    p->s.ptr = bp->s.ptr;
    5fea:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5fec:	00003717          	auipc	a4,0x3
    5ff0:	44f73a23          	sd	a5,1108(a4) # 9440 <freep>
}
    5ff4:	6422                	ld	s0,8(sp)
    5ff6:	0141                	addi	sp,sp,16
    5ff8:	8082                	ret

0000000000005ffa <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5ffa:	7139                	addi	sp,sp,-64
    5ffc:	fc06                	sd	ra,56(sp)
    5ffe:	f822                	sd	s0,48(sp)
    6000:	f426                	sd	s1,40(sp)
    6002:	f04a                	sd	s2,32(sp)
    6004:	ec4e                	sd	s3,24(sp)
    6006:	e852                	sd	s4,16(sp)
    6008:	e456                	sd	s5,8(sp)
    600a:	e05a                	sd	s6,0(sp)
    600c:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    600e:	02051493          	slli	s1,a0,0x20
    6012:	9081                	srli	s1,s1,0x20
    6014:	04bd                	addi	s1,s1,15
    6016:	8091                	srli	s1,s1,0x4
    6018:	0014899b          	addiw	s3,s1,1
    601c:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    601e:	00003517          	auipc	a0,0x3
    6022:	42253503          	ld	a0,1058(a0) # 9440 <freep>
    6026:	c515                	beqz	a0,6052 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    6028:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    602a:	4798                	lw	a4,8(a5)
    602c:	02977f63          	bgeu	a4,s1,606a <malloc+0x70>
    6030:	8a4e                	mv	s4,s3
    6032:	0009871b          	sext.w	a4,s3
    6036:	6685                	lui	a3,0x1
    6038:	00d77363          	bgeu	a4,a3,603e <malloc+0x44>
    603c:	6a05                	lui	s4,0x1
    603e:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    6042:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    6046:	00003917          	auipc	s2,0x3
    604a:	3fa90913          	addi	s2,s2,1018 # 9440 <freep>
  if(p == (char*)-1)
    604e:	5afd                	li	s5,-1
    6050:	a895                	j	60c4 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    6052:	0000a797          	auipc	a5,0xa
    6056:	c1678793          	addi	a5,a5,-1002 # fc68 <base>
    605a:	00003717          	auipc	a4,0x3
    605e:	3ef73323          	sd	a5,998(a4) # 9440 <freep>
    6062:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    6064:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    6068:	b7e1                	j	6030 <malloc+0x36>
      if(p->s.size == nunits)
    606a:	02e48c63          	beq	s1,a4,60a2 <malloc+0xa8>
        p->s.size -= nunits;
    606e:	4137073b          	subw	a4,a4,s3
    6072:	c798                	sw	a4,8(a5)
        p += p->s.size;
    6074:	02071693          	slli	a3,a4,0x20
    6078:	01c6d713          	srli	a4,a3,0x1c
    607c:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    607e:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    6082:	00003717          	auipc	a4,0x3
    6086:	3aa73f23          	sd	a0,958(a4) # 9440 <freep>
      return (void*)(p + 1);
    608a:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    608e:	70e2                	ld	ra,56(sp)
    6090:	7442                	ld	s0,48(sp)
    6092:	74a2                	ld	s1,40(sp)
    6094:	7902                	ld	s2,32(sp)
    6096:	69e2                	ld	s3,24(sp)
    6098:	6a42                	ld	s4,16(sp)
    609a:	6aa2                	ld	s5,8(sp)
    609c:	6b02                	ld	s6,0(sp)
    609e:	6121                	addi	sp,sp,64
    60a0:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    60a2:	6398                	ld	a4,0(a5)
    60a4:	e118                	sd	a4,0(a0)
    60a6:	bff1                	j	6082 <malloc+0x88>
  hp->s.size = nu;
    60a8:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    60ac:	0541                	addi	a0,a0,16
    60ae:	00000097          	auipc	ra,0x0
    60b2:	eca080e7          	jalr	-310(ra) # 5f78 <free>
  return freep;
    60b6:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    60ba:	d971                	beqz	a0,608e <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    60bc:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    60be:	4798                	lw	a4,8(a5)
    60c0:	fa9775e3          	bgeu	a4,s1,606a <malloc+0x70>
    if(p == freep)
    60c4:	00093703          	ld	a4,0(s2)
    60c8:	853e                	mv	a0,a5
    60ca:	fef719e3          	bne	a4,a5,60bc <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    60ce:	8552                	mv	a0,s4
    60d0:	00000097          	auipc	ra,0x0
    60d4:	b78080e7          	jalr	-1160(ra) # 5c48 <sbrk>
  if(p == (char*)-1)
    60d8:	fd5518e3          	bne	a0,s5,60a8 <malloc+0xae>
        return 0;
    60dc:	4501                	li	a0,0
    60de:	bf45                	j	608e <malloc+0x94>
