...
int main() {
  ...
  16:	31a080e7          	jalr	794(ra) # 32c <fork>
      if (pid < 0)
...
// #endif
  ...
  42:	82250513          	addi	a0,a0,-2014 # 860 <malloc+0xf2>
  46:	00000097          	auipc	ra,0x0
  4a:	670080e7          	jalr	1648(ra) # 6b6 <printf>
  exit(0);
  4e:	4501                	li	a0,0
  50:	00000097          	auipc	ra,0x0
  54:	2e4080e7          	jalr	740(ra) # 334 <exit>
          if (n < IO) {
  58:	4791                	li	a5,4
  5a:	0097dd63          	bge	a5,s1,74 <main+0x74>
  5e:	009897b7          	lui	a5,0x989
  62:	68078793          	addi	a5,a5,1664 # 989680 <base+0x988670>
            for (int i = 0; i < 10000000; i++) {}; // CPU bound process
  66:	37fd                	addiw	a5,a5,-1
  68:	fffd                	bnez	a5,66 <main+0x66>
          exit(0);
  6a:	4501                	li	a0,0
  6c:	00000097          	auipc	ra,0x0
  70:	2c8080e7          	jalr	712(ra) # 334 <exit>
            sleep(200); // IO bound processes
  74:	0c800513          	li	a0,200
  78:	00000097          	auipc	ra,0x0
  7c:	34c080e7          	jalr	844(ra) # 3c4 <sleep>
  80:	b7ed                	j	6a <main+0x6a>
  for(;n > 0; n--) {
  82:	34fd                	addiw	s1,s1,-1
  84:	d8c5                	beqz	s1,34 <main+0x34>
      if(waitx(0,&wtime,&rtime) >= 0) {
  86:	fc840613          	addi	a2,s0,-56
  8a:	fcc40593          	addi	a1,s0,-52
  8e:	4501                	li	a0,0
  90:	00000097          	auipc	ra,0x0
  94:	344080e7          	jalr	836(ra) # 3d4 <waitx>
  98:	fe0545e3          	bltz	a0,82 <main+0x82>
          trtime += rtime;
  9c:	fc842783          	lw	a5,-56(s0)
  a0:	0127893b          	addw	s2,a5,s2
          twtime += wtime;
  a4:	fcc42783          	lw	a5,-52(s0)
  a8:	013789bb          	addw	s3,a5,s3
  ac:	bfd9                	j	82 <main+0x82>
